 ...
 *
 */
public class MdocVerifiedClaimBiometricTemplateXX extends VerifiedClaimByteString implements VerifiedClaimBiometricTemplateXX {
     ...
     */
    public MdocVerifiedClaimBiometricTemplateXX(VerifiedClaimByteString value) {
