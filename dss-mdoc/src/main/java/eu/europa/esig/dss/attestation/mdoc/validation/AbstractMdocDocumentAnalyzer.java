 ...
 *
 */
public abstract class AbstractMdocDocumentAnalyzer extends DefaultAttestationDocumentAnalyzer {

    /**
     * Default constructor
     */
    protected AbstractMdocDocumentAnalyzer() {
        // empty
    }
     ...
     */
    protected AbstractMdocDocumentAnalyzer(DSSDocument document) {
        Objects.requireNonNull(document, "Document to be validated cannot be null!");
        this.document = document;
    }

    @Override
    protected MdocValidationParameters getAttestationValidationParameters() {
        AttestationValidationParameters attestationValidationParameters = super.getAttestationValidationParameters();
    ...
    public void setAttestationValidationParameters(AttestationValidationParameters attestationValidationParameters) {
        ...
        super.setAttestationValidationParameters(attestationValidationParameters);
    }
