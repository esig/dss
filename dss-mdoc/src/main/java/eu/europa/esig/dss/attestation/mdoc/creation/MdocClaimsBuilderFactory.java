...
/**
 * Loads the relevant {@code eu.europa.esig.dss.attestation.mdoc.creation.MdocClaimsBuilder} based on the input configuration
 *
 */
public interface MdocClaimsBuilderFactory {
     ...
     */
    MdocClaimsBuilder create(MdocPayloadParameters payloadParameters);
