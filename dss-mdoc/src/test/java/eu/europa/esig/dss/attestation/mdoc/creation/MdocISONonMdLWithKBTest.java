...
class MdocISONonMdLWithKBTest extends AbstractMdocDeviceResponseTestCreation {
    ...
    protected void checkClaims(DiagnosticData diagnosticData) {
        ...
        final List<ClaimWrapper> otherKeyBindingPayloadClaims = attestation.getOtherKeyBindingPayloadClaims();
