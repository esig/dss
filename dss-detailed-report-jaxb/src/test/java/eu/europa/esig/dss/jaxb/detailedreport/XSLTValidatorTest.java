...
public class XSLTValidatorTest {
	...
	public void validateXsltHTML() throws TransformerConfigurationException {
		Transformer transformer = TF.newTransformer(new StreamSource("src/main/resources/xslt/html/detailed-report.xslt"));
		assertNotNull(transformer);
	}

	@Test
	public void validateXsltPDF() throws TransformerConfigurationException {
		Transformer transformer = TF.newTransformer(new StreamSource("src/main/resources/xslt/pdf/detailed-report.xslt"));
		assertNotNull(transformer);
	}
