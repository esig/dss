 ...
 * Please see "5.2. Status List Token in CWT Format" of draft-ietf-oauth-revocation-list-20.html.
 *
 */
public enum CWTStatusListClaims {

    /**
     * The revocation list map.
     */
    STATUS_LIST(65533L),
    ...
    /**
     * The revocation values for all the Referenced Tokens it conveys statuses for
     */
    STATUS_LIST_LST("lst");
