...
public class TimestampTokenComparatorTest {
	...
	public void test() throws Exception {
		...
		firstTimestampTokenDuplicate = new TimestampToken(Utils.fromBase64(firstBinaries), TimestampType.SIGNATURE_TIMESTAMP, new CertificatePool(), 
		...
		secondTimestampToken = new TimestampToken(Utils.fromBase64(secondBinaries), TimestampType.SIGNATURE_TIMESTAMP, new CertificatePool(), 
				Arrays.asList(new TimestampedReference("", TimestampedObjectType.TIMESTAMP)), TimestampLocation.DOC_TIMESTAMP);
