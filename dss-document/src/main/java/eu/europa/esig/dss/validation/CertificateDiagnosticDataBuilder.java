...
/**
 * Builds a diagnostic data for a certificate validation (with revocation data)
 *
 */
public class CertificateDiagnosticDataBuilder implements DiagnosticDataBuilder {

	private static final Logger LOG = LoggerFactory.getLogger(CertificateDiagnosticDataBuilder.class);
