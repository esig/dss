...
/**
 * This class creates a {@code TempFileResourcesFactory} storing temporary objects to temporary filesystem documents
 */
public class TempFileResourcesFactoryBuilder implements DSSResourcesFactoryBuilder<TempFileResourcesFactory> {
     ...
     * @return {@link TempFileResourcesFactoryBuilder} this builder
     */
    public TempFileResourcesFactoryBuilder setFileNamePrefix(String fileNamePrefix) {
     ...
     * @return {@link TempFileResourcesFactoryBuilder} this builder
     */
    public TempFileResourcesFactoryBuilder setFileNameSuffix(String fileNameSuffix) {
     ...
     * @return {@link TempFileResourcesFactoryBuilder} this builder
     */
    public TempFileResourcesFactoryBuilder setTempFileDirectory(File tempFileDirectory) {
        this.tempFileDirectory = tempFileDirectory;
        return this;
    }

    @Override
    public TempFileResourcesFactory instantiateFactory() {
        return new TempFileResourcesFactory(fileNamePrefix, fileNameSuffix, tempFileDirectory);
    }
