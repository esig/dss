...
class CAdESLevelBWithSignaturePolicyWithUriTest extends AbstractCAdESTestSignature {

	private static final String HTTP_SPURI_TEST = "http://spuri.test";
	private static final String SIGNATURE_POLICY_ID = "1.2.3.4.5.6";

	private static final DSSDocument POLICY_CONTENT = new InMemoryDocument(CAdESLevelBWithSignaturePolicyWithUriTest.class.getResourceAsStream("/validation/signature-policy.der"));
