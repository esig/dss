...
@Tag("slow")
public class CAdESSignWithAtomicMethodsTest extends AbstractCAdESTestSignature {
    ...
    private CAdESSignatureParameters createSignatureParametersCopy(CAdESSignatureParameters signatureParameters) {
        CAdESSignatureParameters signatureParametersCopy = new CAdESSignatureParameters();
