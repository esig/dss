...
class CAdESLevelLTAddASN1EvidenceRecordHashtreeRenewedInvalidTstTest extends AbstractCAdESAddEvidenceRecordTest {
    ...
    protected DSSDocument getEvidenceRecordDocument() {
        return new InMemoryDocument(CAdESLevelLTAddASN1EvidenceRecordTest.class.getResourceAsStream(
                "/validation/evidence-record/evidence-record-d233a2d9-a257-40dc-bcdb-bf4516b6d1da_renewed_hashtree-broken-tst.ers"));
    }
