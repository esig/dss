...
public class SignedAssertion extends ASN1Object {
    ...
    public SignedAssertion(String id, String assertion) {

        this.id = new DERPrintableString(id);
    ...
    private SignedAssertion(ASN1Sequence seq) {
        ...
        this.id = DERPrintableString.getInstance(seq.getObjectAt(0));
