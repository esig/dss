...
public class SignerAttributeV2 extends ASN1Object {
    ...
    public static SignerAttributeV2 getInstance(
            Object o) {
        if (o instanceof SignerAttributeV2) {
            ...
            try {
                ...
                java.util.logging.Logger.getLogger(SignerAttributeV2.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
    ...
    private SignerAttributeV2(
            ASN1Sequence seq) throws IOException {
        int size = seq.size();
    ...
    private SignerAttributeV2(SignerAttributeV2Builder builder) {
        ...
        if (!builder.claimedAttributes.isEmpty()) {
            objects.add(builder.claimedAttributes.toArray(new Attribute[0]));
        }
    ...
    public static class SignerAttributeV2Builder {
        ...
        private List<SignedAssertion> signedAssertions = new ArrayList<>();
        private List<Attribute> claimedAttributes = new ArrayList<>();
