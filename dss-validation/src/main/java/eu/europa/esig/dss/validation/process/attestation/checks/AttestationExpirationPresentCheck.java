...
/**
 * This class verifies whether the attestation contains the expiration
 *
 */
public class AttestationExpirationPresentCheck extends ChainItem<XmlSAV> {
     ...
     */
    public AttestationExpirationPresentCheck(I18nProvider i18nProvider, XmlSAV result,
    ...
    protected boolean process() {
        return attestation.getExpiration() != null;
    }
