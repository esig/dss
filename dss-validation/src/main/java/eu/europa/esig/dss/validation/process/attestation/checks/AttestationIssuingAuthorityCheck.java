...
/**
 * This class verifies whether the attestation issuing authority claim contains one of the expected values
 *
 */
public class AttestationIssuingAuthorityCheck extends AbstractMultiValuesCheckItem<XmlSAV> {
     ...
     */
    public AttestationIssuingAuthorityCheck(final I18nProvider i18nProvider, final XmlSAV result,
    ...
    protected boolean process() {
        return processValueCheck(attestation.getDocumentIssuingAuthority());
    }
