 ...
 */
public class OrganizationIdentifierCheck extends AbstractMultiValuesCheckItem<XmlSubXCV> {
    ...
    protected boolean process() {
        return processValueCheck(certificate.getOrganizationIdentifier());
    }

    @Override
    protected MessageTag getMessageTag() {
        return MessageTag.BBB_XCV_ISCGORGAI;
    }

    @Override
    protected MessageTag getErrorMessageTag() {
        return MessageTag.BBB_XCV_ISCGORGAI_ANS;
    }
