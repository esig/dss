 ...
 *
 */
public class AttestationSubjectPseudonymCheck extends AbstractMultiValuesCheckItem<XmlSAV> {
     ...
     */
    public AttestationSubjectPseudonymCheck(final I18nProvider i18nProvider, final XmlSAV result,
