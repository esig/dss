...
/**
 * This class verifies whether the attestation issuing country claim contains one of the expected values
 *
 */
public class AttestationIssuingCountryCheck extends AbstractMultiValuesCheckItem<XmlSAV> {
     ...
     */
    public AttestationIssuingCountryCheck(I18nProvider i18nProvider, XmlSAV result,
    ...
    protected boolean process() {
        return processValueCheck(attestation.getDocumentIssuingAuthorityCountry());
    }
