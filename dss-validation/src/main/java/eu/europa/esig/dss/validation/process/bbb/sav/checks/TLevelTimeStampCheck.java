 ...
 */
public class TLevelTimeStampCheck<T extends XmlConstraintsConclusion> extends AbstractTimeStampPresentCheck<T> {
     ...
     */
    public TLevelTimeStampCheck(I18nProvider i18nProvider, T result, SignatureWrapper signature,
