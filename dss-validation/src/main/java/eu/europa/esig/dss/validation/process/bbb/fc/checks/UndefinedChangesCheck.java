...
public class UndefinedChangesCheck extends ChainItem<XmlFC> {
     ...
     */
    public UndefinedChangesCheck(I18nProvider i18nProvider, XmlFC result, PDFRevisionWrapper pdfRevision, LevelConstraint constraint) {
    ...
    protected boolean process() {
        return Utils.isCollectionEmpty(pdfRevision.getPdfUndefinedChanges());
    }
