...
/**
 * Checks whether the corresponding status declares that the EAA is not on hold
 *
 */
public class AttestationNotOnHoldCheck extends ChainItem<XmlSAV> {
    ...
    protected MessageTag getMessageTag() {
        return MessageTag.EAA_REV_NOT_ON_HOLD;
    }

    @Override
    protected MessageTag getErrorMessageTag() {
        return MessageTag.EAA_REV_NOT_ON_HOLD_ANS;
    }
