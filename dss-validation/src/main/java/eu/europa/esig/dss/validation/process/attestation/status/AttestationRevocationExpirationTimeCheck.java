...
/**
 * Verifies whether the attestation revocation token contains an expiration time
 *
 */
public class AttestationRevocationExpirationTimeCheck extends ChainItem<XmlSAV> {
     ...
     */
    public AttestationRevocationExpirationTimeCheck(I18nProvider i18nProvider, XmlSAV result,
    ...
    protected boolean process() {
        return attestationRevocationToken.getExpirationTime() != null;
    }
