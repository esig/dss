...
import eu.europa.esig.dss.validation.process.qualification.attestation.checks.AttestationCategoryForEAAPresenceCheck;
import eu.europa.esig.dss.validation.process.qualification.attestation.checks.AttestationCategoryForPubEAACheck;
import eu.europa.esig.dss.validation.process.qualification.attestation.checks.AttestationCategoryForQEAACheck;
import eu.europa.esig.dss.validation.process.qualification.attestation.checks.AttestationIssuerQcPSBPresentCheck;
import eu.europa.esig.dss.validation.process.qualification.attestation.checks.AttestationQualifiedSignatureOrSealCheck;
import eu.europa.esig.dss.validation.process.qualification.attestation.checks.QEAACheck;
