...
class PdfVisualDifferenceCheckTest extends AbstractTestCheck {
	...
	void valid() {
		...
		PdfVisualDifferenceCheck pvdc = new PdfVisualDifferenceCheck(i18nProvider, result, new PDFRevisionWrapper(pdfRevision), new LevelConstraintWrapper(constraint));
		pvdc.execute();
