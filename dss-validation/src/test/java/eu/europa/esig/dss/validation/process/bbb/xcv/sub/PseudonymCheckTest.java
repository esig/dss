...
class PseudonymCheckTest extends AbstractTestCheck {
	...
	void pseudonymCheck() {
		...
		PseudonymCheck pc = new PseudonymCheck(i18nProvider, result, new CertificateWrapper(xc), new MultiValuesConstraintWrapper(constraint));
		pc.execute();
