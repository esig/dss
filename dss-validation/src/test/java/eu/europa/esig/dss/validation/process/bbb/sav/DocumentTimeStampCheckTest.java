...
class DocumentTimeStampCheckTest extends AbstractTestCheck {
    ...
    void valid() {
        ...
        xmlTimestamp.setType(TimestampType.DOCUMENT_TIMESTAMP);
        ...
        DocumentTimeStampCheck dtsc = new DocumentTimeStampCheck(i18nProvider, result, new SignatureWrapper(sig), new LevelConstraintWrapper(constraint));
        dtsc.execute();
    ...
    void multipleEntries() {
        ...
        xmlTimestampTwo.setType(TimestampType.DOCUMENT_TIMESTAMP);
