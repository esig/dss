...
class AttestationAdministrativeIssuanceDatePresentCheckTest extends AbstractTestCheck {
    ...
    void validTest() {
        ...
        xmlAttestationPayload.setAdministrativeIssuanceDate(issuance);
        xmlAttestation.setAttestationPayload(xmlAttestationPayload);

        XmlSAV result = new XmlSAV();

        AttestationAdministrativeIssuanceDatePresentCheck administrativeIssuanceDatePresentCheck = new AttestationAdministrativeIssuanceDatePresentCheck(
