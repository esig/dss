...
class CertificateIssuedToLegalPersonCheckTest extends AbstractTestCheck {
	...
	void certificateIssuedToLegalPersonWithPolicyIdentifierCheck() {
		...
		CertificateIssuedToLegalPersonCheck citlp = new CertificateIssuedToLegalPersonCheck(i18nProvider, result, new CertificateWrapper(xc), new LevelConstraintWrapper(constraint));
		citlp.execute();
