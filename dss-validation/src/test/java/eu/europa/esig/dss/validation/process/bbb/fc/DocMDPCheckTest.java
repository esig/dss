...
class DocMDPCheckTest extends AbstractTestCheck {

    @Test
    void noChangesPermittedValid() {
    ...
    @Test
    void minimalChangesPermittedValid() {
        XmlPDFRevision pdfRevision = new XmlPDFRevision();
    ...
    @Test
    void minimalChangesPermittedFail() {
        XmlPDFRevision pdfRevision = new XmlPDFRevision();
