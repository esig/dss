...
class SignatureTimeStampCheckTest extends AbstractTestCheck {
    ...
    void valid() {
        ...
        SignatureTimeStampCheck stsc = new SignatureTimeStampCheck(i18nProvider, result, new SignatureWrapper(sig), new LevelConstraintWrapper(constraint));
        stsc.execute();
