...
class CommonNameCheckTest extends AbstractTestCheck {
	...
	void commonNameCheck() {
		...
		CommonNameCheck cnc = new CommonNameCheck(i18nProvider, result, new CertificateWrapper(xc), new MultiValuesConstraintWrapper(constraint));
		cnc.execute();
