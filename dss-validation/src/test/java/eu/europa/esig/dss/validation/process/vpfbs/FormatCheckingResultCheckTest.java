...
class FormatCheckingResultCheckTest extends AbstractTestCheck {
    ...
    void validTest() {
        ...
        FormatCheckingResultCheck fcrc = new FormatCheckingResultCheck<>(
                i18nProvider, result, xmlFC, new SignatureWrapper(new XmlSignature()), new LevelConstraintWrapper(constraint));
        fcrc.execute();
