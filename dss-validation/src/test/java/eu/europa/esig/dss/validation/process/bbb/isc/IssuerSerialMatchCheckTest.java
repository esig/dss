...
class IssuerSerialMatchCheckTest extends AbstractTestCheck {
	...
	@Test
	void issuerSerialMatchCheckTest() {
		...
		IssuerSerialMatchCheck ismc = new IssuerSerialMatchCheck(i18nProvider, result, new SignatureWrapper(xmlSignature), new LevelConstraintWrapper(constraint));
		ismc.execute();
	...
	@Test
	void issuerSerialNotMatchCheckTest() {
		XmlCertificateRef xmlCertificateRef = new XmlCertificateRef();
		xmlCertificateRef.setOrigin(CertificateRefOrigin.SIGNING_CERTIFICATE);
