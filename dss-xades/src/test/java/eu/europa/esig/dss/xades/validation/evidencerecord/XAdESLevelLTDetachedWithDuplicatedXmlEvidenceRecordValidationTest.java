...
public class XAdESLevelLTDetachedWithDuplicatedXmlEvidenceRecordValidationTest extends AbstractXAdESWithEvidenceRecordTestValidation {

    @Override
    protected DSSDocument getSignedDocument() {
        return new FileDocument("src/test/resources/validation/evidence-record/X-B-B-DETACHED-1-extended-xades-baseline-lt.xml");
    }
    ...
    protected List<DSSDocument> getDetachedEvidenceRecords() {
        FileDocument erDocumentOne = new FileDocument("src/test/resources/validation/evidence-record/evidence-record-detached.xml");
        FileDocument erDocumentTwo = new FileDocument("src/test/resources/validation/evidence-record/evidence-record-detached.xml");
        erDocumentTwo.setName("new_er_name.xml");
        return Arrays.asList(erDocumentOne, erDocumentTwo);
    }
