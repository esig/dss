...
public class XAdESLevelLTTstRevocationFreshnessNextUpdateFailTest extends AbstractXAdESTestSignature {
    ...
    protected SignedDocumentValidator getValidator(DSSDocument signedDocument) {
        ...
        revocationDataVerifier.setTimestampMaximumRevocationFreshness(null);
        ...
        documentValidator.setValidationTime(calendar.getTime());
