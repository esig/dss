...
public class XAdESDoubleAv2Test extends XAdESDoubleATest {
    ...
    protected void onDocumentSigned(byte[] byteArray) {
        ...
        NodeList timestampValidationDataList = XPathUtils.getNodeList(signature, paths.getTimestampValidationDataPath());
