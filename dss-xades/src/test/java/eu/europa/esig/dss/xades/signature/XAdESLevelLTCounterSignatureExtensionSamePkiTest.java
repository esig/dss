...
@Tag("slow")
class XAdESLevelLTCounterSignatureExtensionSamePkiTest extends AbstractXAdESCounterSignatureTest {
    ...
    protected void checkCertificateValuesEncapsulation(DiagnosticData diagnosticData) {
        ...
        switch (vdStrategy) {
            ...
            case CERTIFICATE_REVOCATION_VALUES_AND_TIMESTAMP_VALIDATION_DATA_LT_SEPARATED:
                ...
                assertEquals(1, signature.foundCertificates().getRelatedCertificatesByOrigin(CertificateOrigin.TIMESTAMP_VALIDATION_DATA).size());
                assertEquals(0, signature.foundCertificates().getRelatedCertificatesByOrigin(CertificateOrigin.ANY_VALIDATION_DATA).size());
                break;
            ...
            case CERTIFICATE_REVOCATION_VALUES_AND_ANY_VALIDATION_DATA:
                assertEquals(2, signature.foundCertificates().getRelatedCertificatesByOrigin(CertificateOrigin.CERTIFICATE_VALUES).size());
                assertEquals(0, signature.foundCertificates().getRelatedCertificatesByOrigin(CertificateOrigin.TIMESTAMP_VALIDATION_DATA).size());
                assertEquals(1, signature.foundCertificates().getRelatedCertificatesByOrigin(CertificateOrigin.ANY_VALIDATION_DATA).size());
                break;
            case ANY_VALIDATION_DATA_ONLY:
                ...
                assertEquals(0, signature.foundCertificates().getRelatedCertificatesByOrigin(CertificateOrigin.TIMESTAMP_VALIDATION_DATA).size());
                assertEquals(3, signature.foundCertificates().getRelatedCertificatesByOrigin(CertificateOrigin.ANY_VALIDATION_DATA).size());
                break;
            default:
