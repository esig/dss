...
class XAdESLevelBCrossCertificationTest extends AbstractXAdESTestSignature {
    ...
    protected CertificateSource getTrustedCertificateSource() {
        ...
        trustedCertificateSource.addCertificate(getCertificateByPrimaryKey(2003, "cc-root-ca"));
