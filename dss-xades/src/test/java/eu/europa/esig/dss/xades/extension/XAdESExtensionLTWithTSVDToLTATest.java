...
public class XAdESExtensionLTWithTSVDToLTATest extends XAdESExtensionLTToLTATest {

    @Override
    protected DSSDocument getSignedDocument(DSSDocument doc) {
        doc = new FileDocument("src/test/resources/validation/xades-t-with-tsvd.xml");
        XAdESService service = getSignatureServiceToExtend();
        return service.extendDocument(doc, getSignatureParameters());
    }
