...
public class DSS1987Test extends PKIFactoryAccess {
	...
	@Test
	public void testWithoutCTS() {
		DSSDocument doc = new FileDocument(
				"src/test/resources/validation/dss1987/data2sign-signed-xades-enveloped-baseline-lta.xml");
	...
	@Test
	public void testWithCTS() {
		DSSDocument doc = new FileDocument(
				"src/test/resources/validation/dss1987/data2sign-signed-xades-enveloped-baseline-cts-lta.xml");
		SignedDocumentValidator validator = SignedDocumentValidator.fromDocument(doc);
		validator.setCertificateVerifier(getCertificateVerifier());
	...
	private void checkReports(Reports reports) {
		...
		String signatureTimestampId = signatureTimestamps.get(0).getId();

		// Long term and archival validation must be covered with the signature timestamp Id
		...
		// Validation time must be equals to the signature timestamp Id
