...
public class XAdESLevelBEnvelopingSignDocWithCommentsEmbedXmlTest extends AbstractXAdESTestSignature {
    ...
    protected void verifyOriginalDocuments(SignedDocumentValidator validator, DiagnosticData diagnosticData) {
        ...
        byte[] retrievedDoc = DSSXMLUtils.serializeNode(DomUtils.buildDOM(originalDocuments.get(0)));
        assertArrayEquals(DSSXMLUtils.serializeNode(DomUtils.buildDOM(documentToSign)), retrievedDoc);
