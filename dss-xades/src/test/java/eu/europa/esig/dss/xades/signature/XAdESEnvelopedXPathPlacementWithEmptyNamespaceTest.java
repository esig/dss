...
public class XAdESEnvelopedXPathPlacementWithEmptyNamespaceTest extends AbstractXAdESTestSignature {
    ...
    public void init() throws Exception {
        ...
        DSSNamespace xadesNamespace = new DSSNamespace(XAdESNamespace.XADES_132.getUri(), "");
