...
@Tag("slow")
class XAdESSignWithAtomicMethodsTest extends AbstractXAdESTestSignature {
    ...
    private XAdESSignatureParameters createSignatureParametersCopy(XAdESSignatureParameters signatureParameters) {
        XAdESSignatureParameters signatureParametersCopy = new XAdESSignatureParameters();
