...
public class XAdESLevelBEnvelopedDataObjectFormatWrongEncodingTest extends AbstractXAdESTestSignature {
    ...
    public void init() throws Exception {
        ...
        envelopingDataObjectFormat.setMimeType(MimeTypeEnum.PNG.getMimeTypeString());
        envelopingDataObjectFormat.setEncoding("DER");
