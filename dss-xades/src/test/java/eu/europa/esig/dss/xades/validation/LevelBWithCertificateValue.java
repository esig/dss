...
public class LevelBWithCertificateValue {
	...
	@Test
	public void test() {
		SignedDocumentValidator validator = SignedDocumentValidator.fromDocument(new FileDocument("src/test/resources/validation/BaselineBWithCertificateValues.xml"));
