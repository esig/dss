...
@Tag("slow")
class XAdESLevelBEnvelopedNONEWithRSASelfEncodedTest extends AbstractXAdESTestSignature {
    ...
    protected DSSDocument sign() {
        ...
        Digest digest = new Digest(signatureParameters.getDigestAlgorithm(),
                DigestInfoEncoder.encode(signatureParameters.getDigestAlgorithm().getOid(), originalDigest));
