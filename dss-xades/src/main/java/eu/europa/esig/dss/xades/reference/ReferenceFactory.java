...
public class ReferenceFactory {
	...
	private DSSReference envelopedDSSReference(DSSDocument document, int index) {
		...
		XPathEnvelopedSignatureTransform xPathTransform = new XPathEnvelopedSignatureTransform(signatureParameters.getXmldsigNamespace());
...
//		byte[] bytesAfterTransformation = applyTransformations(reference, nodeToTransform);
//		LOG.info(new String(bytesAfterTransformation));
		return new InMemoryDocument(applyTransformations(reference, nodeToTransform));
	}
