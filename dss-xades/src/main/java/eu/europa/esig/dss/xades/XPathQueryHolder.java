...
public class XPathQueryHolder implements Serializable {
	...
	public static final String XMLE_TIMESTAMP_VALIDATION_DATA = "TimeStampValidationData";
	...
	public String XPATH_TIME_STAMP_VALIDATION_DATA = XPATH_UNSIGNED_SIGNATURE_PROPERTIES + "/xades141:" + XMLE_TIMESTAMP_VALIDATION_DATA;
	...
	public String XPATH__ENCAPSULATED_X509_CERTIFICATE = "." + XPATH_CV + XPATH_EX509C;
