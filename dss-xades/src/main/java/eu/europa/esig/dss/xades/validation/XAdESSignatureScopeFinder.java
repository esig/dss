...
import eu.europa.esig.dss.validation.ManifestEntrySignatureScope;
...
//					XAdESUtils.isKeyInfoReference(signatureReference, xadesSignature.getSignatureElement(), xadesSignature.getXPathQueryHolder())) {
//				continue;
//			}
