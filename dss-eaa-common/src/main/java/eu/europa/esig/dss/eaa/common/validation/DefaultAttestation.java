...
import eu.europa.esig.dss.eaa.common.validation.identifier.AttestationIdentifierBuilder;
...
public abstract class DefaultAttestation implements Attestation {
    ...
    protected static abstract class DefaultAttestationBuilder {
         ...
         * @return this builder
         */
        public DefaultAttestationBuilder setDisclosures(List<ValidationDisclosure> disclosures) {
