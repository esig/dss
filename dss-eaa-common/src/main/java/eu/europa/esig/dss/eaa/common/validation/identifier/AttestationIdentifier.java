...
/**
 * Builds identifier for attestation token
 *
 */
public class AttestationIdentifier extends MultipleDigestIdentifier {
     ...
     */
    protected AttestationIdentifier(byte[] binaries) {
        super("A-", binaries);
    }
