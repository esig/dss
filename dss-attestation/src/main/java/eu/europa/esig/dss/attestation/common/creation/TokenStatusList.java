...
/**
 * Represents a status_list structure as specified in clause 6 of IETF draft-ietf-oauth-revocation-list-13.
 *
 */
public class TokenStatusList implements Serializable {
    ...
    /** Non-negative integer representing the index check for revocation information in the Status List */
    ...
    /**
     * Gets index of the token within a revocation list
     *
    ...
    /**
     * Gets URI of the revocation list
     *
     * @return {@link String}
     */
