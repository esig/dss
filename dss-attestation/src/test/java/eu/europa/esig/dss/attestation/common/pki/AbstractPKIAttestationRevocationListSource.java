 ...
 */
package eu.europa.esig.dss.attestation.common.pki;
...
public abstract class AbstractPKIAttestationRevocationListSource<T extends SerializableSignatureParameters> implements AttestationRevocationSource {
    ...
    /**
     * Cert Entity issuing the revocation list responses
     */
    ...
    /**
     * Time of the revocation list issuance
     */
    protected Date issuanceTime;

    /**
     * Time of the revocation list expiration
     */
    ...
    /**
     * Generates the revocation list token
     *
