...
public class JAdESSignatureIdentifier extends SignatureIdentifier {
	...
	private static final long serialVersionUID = -2018798309741692802L;
	...
	private static byte[] buildBinaries(JAdESSignature signature) {
		...
		return buildSignatureIdentifier(signature.getSigningTime(), identifier, signature.getJws().getEncodedSignature());
	}
