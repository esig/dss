...
public class JAdESSerializationWrongPayloadTypeSignatureTest extends AbstractJAdESTestSignature {
	...
	public void init() throws Exception {
		documentToSign = new FileDocument(new File("src/test/resources/validation/serialization-wrong-payload-type.json"));
