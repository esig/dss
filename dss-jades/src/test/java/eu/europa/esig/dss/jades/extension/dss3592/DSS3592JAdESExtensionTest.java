...
class DSS3592JAdESExtensionTest extends AbstractJAdESTestExtension {
    ...
    protected void checkOriginalLevel(DiagnosticData diagnosticData) {
        ...
        for (SignatureWrapper signatureWrapper : diagnosticData.getSignatures()) {
            if (SignatureLevel.JAdES_BASELINE_B == signatureWrapper.getSignatureFormat()) {
                ++bLevelCounter;
            } else if (SignatureLevel.JAdES_BASELINE_T == signatureWrapper.getSignatureFormat()) {
                ++tLevelCounter;
            }
        }
    ...
    protected void checkFinalLevel(DiagnosticData diagnosticData) {
        ...
        for (SignatureWrapper signatureWrapper : diagnosticData.getSignatures()) {
            if (SignatureLevel.JAdES_BASELINE_LTA == signatureWrapper.getSignatureFormat()) {
                ++ltaLevelCounter;
            }
        }
