...
class JAdESLevelBX5CProtectedHeaderPlacementTest extends AbstractJAdESTestSignature {
    ...
    void init() {
        ...
        signatureParameters.setX5CHeaderPlacement(JAdESSignatureParameters.X5CHeaderPlacement.protectedHeader);
    }
