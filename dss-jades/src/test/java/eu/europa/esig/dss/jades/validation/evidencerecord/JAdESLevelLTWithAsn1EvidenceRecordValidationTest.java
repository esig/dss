...
class JAdESLevelLTWithAsn1EvidenceRecordValidationTest extends AbstractJAdESWithEvidenceRecordTestValidation {

    @Override
    protected DSSDocument getSignedDocument() {
        return new FileDocument("src/test/resources/validation/evidence-record/Signature-J-LT-a0baac29-c2b6-4544-abc5-d26ac6c8b655.json");
    }
