...
/**
 * This class verifies whether the provided EAA supports the given revocation revocation verification mechanism,
...
public interface AttestationRevocationValidator {
    ...
    /**
     * Verifies whether the EAA supports the current revocation verification mechanism.
     * For example EAA contains the required payload claim.
     *
     * @param attestation {@link Attestation} to be verified
     * @return TRUE if the EAA supports given revocation verification mechanism, FALSE otherwise
     */
