...
class EquivalentCertificatesEntityTest {
	...
	@Test
	void test() {
		EquivalentCertificatesEntity cpe = new EquivalentCertificatesEntity(SAME_PK_CERT_1);
		final byte[] ski = cpe.getSki();
		assertNotNull(ski);

		cpe.addEquivalentCertificate(SAME_PK_CERT_1);
		cpe.addEquivalentCertificate(SAME_PK_CERT_2);
		...
		cpe.addEquivalentCertificate(SAME_PK_CERT_3);
		assertEquals(3, cpe.getEquivalentCertificates().size());
	}

	@Test
	void testEquals() {
		CertificateSourceEntity cpe1 = new EquivalentCertificatesEntity(SAME_PK_CERT_1);
		CertificateSourceEntity cpe2 = new EquivalentCertificatesEntity(SAME_PK_CERT_2);
		CertificateSourceEntity cpe3 = new EquivalentCertificatesEntity(SAME_PK_CERT_3);
