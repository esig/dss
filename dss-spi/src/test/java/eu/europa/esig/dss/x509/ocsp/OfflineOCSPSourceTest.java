...
public class OfflineOCSPSourceTest {
	...
	private class MockOfflineOCSPSource extends OfflineOCSPSource {

		private static final long serialVersionUID = 9083959373865388458L;

		private final String ocspResponse;

		public MockOfflineOCSPSource(String ocspResponse) {
		...
		public List<BasicOCSPResp> getContainedOCSPResponses() {
			try {
				return Arrays.asList(DSSRevocationUtils.loadOCSPBase64Encoded(ocspResponse));
			} catch (IOException e) {
