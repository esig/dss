 ...
 *
 */
public class SDJWTVerifiedClaimIntegrity extends VerifiedClaimString implements VerifiedClaimIntegrity {

    private static final long serialVersionUID = -1585182324348523330L;

    private static final Logger LOG = LoggerFactory.getLogger(SDJWTVerifiedClaimIntegrity.class);

    /**
     * Default constructor
     *
     * @param value {@link VerifiedClaimString}
     */
    public SDJWTVerifiedClaimIntegrity(VerifiedClaimString value) {
