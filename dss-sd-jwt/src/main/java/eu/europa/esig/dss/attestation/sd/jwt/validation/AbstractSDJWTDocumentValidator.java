...
/**
 * The abstract class for an SD-JWT validation.
 * <p>
 ...
 *
 */
public abstract class AbstractSDJWTDocumentValidator extends DefaultAttestationDocumentValidator {

    /**
     * Empty constructor
     *
     * @param analyzer {@link AbstractSDJWTDocumentAnalyzer}
     */
    protected AbstractSDJWTDocumentValidator(final AbstractSDJWTDocumentAnalyzer analyzer) {
        super(analyzer);
    }

    @Override
    public AbstractSDJWTDocumentAnalyzer getDocumentAnalyzer() {
        return (AbstractSDJWTDocumentAnalyzer) super.getDocumentAnalyzer();
    }
