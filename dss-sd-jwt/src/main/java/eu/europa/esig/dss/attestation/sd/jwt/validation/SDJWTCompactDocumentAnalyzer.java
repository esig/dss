...
import eu.europa.esig.dss.attestation.sd.jwt.SDJWTCompactSerializationParser;
...
/**
 * This class performs validation of an SD-JWT serialized using compact JWS serialization form
 *
 */
public class SDJWTCompactDocumentAnalyzer extends AbstractSDJWTDocumentAnalyzer {

    private static final Logger LOG = LoggerFactory.getLogger(SDJWTCompactDocumentAnalyzer.class);

    /**
     * Empty constructor
     */
    public SDJWTCompactDocumentAnalyzer() {
        // empty
    }
     ...
     */
    public SDJWTCompactDocumentAnalyzer(DSSDocument document) {
        super(document);
    }
