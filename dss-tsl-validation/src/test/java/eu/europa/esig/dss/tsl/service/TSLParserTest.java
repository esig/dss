...
public class TSLParserTest {
	...
	public void parseLOTL() throws Exception {
		TSLParser parser = new TSLParser(new FileDocument("src/test/resources/LOTL.xml"));
	...
	public void parsePivotLOTL() throws Exception {
		TSLParser parser = new TSLParser(new FileDocument("src/test/resources/pivot-tl-mp.xml"));
		TSLParserResult model = parser.call();
		assertNotNull(model);
		assertNotNull(model.getNextUpdateDate());
		assertNotNull(model.getIssueDate());
	...
	public void countCertificatesLT() throws Exception {
		int oldResult = 35;
		TSLParser parser = new TSLParser(new FileDocument("src/test/resources/tsls/621C7723265CA33AAD0607B3C612B313872E7514.xml"));
		TSLParserResult model = parser.call();
	...
	public void tslWithDateOverlapping() throws Exception {
		TSLParser parser = new TSLParser(new FileDocument("src/test/resources/wrong-service-dates.xml"));
		parser.call();
	}
	...
	public void serviceQualificationEE() throws Exception {
		// ***************************** OLD VERSION OF TL
		TSLParser parser = new TSLParser(new FileDocument("src/test/resources/tsls/0A191C3E18CAB7B783E690D3E4431C354A068FF0.xml"));
		TSLParserResult model = parser.call();
	...
	public void getAdditionnalServiceInfo() throws Exception {
		TSLParser parser = new TSLParser(new FileDocument("src/test/resources/tsls/tsl-be-v5.xml"));
		TSLParserResult model = parser.call();
