...
class DuplicatedStatusInTLValidationJobTest {
	...
	private static final CertificateToken C1 = DSSUtils.loadCertificateFromBase64EncodedString(
	...
	private static final CertificateToken C2 = DSSUtils.loadCertificateFromBase64EncodedString(
