 ...
 */
package eu.europa.esig.dss.ws.eaa.creation.soap;
...
import eu.europa.esig.dss.ws.eaa.creation.soap.client.SoapAttestationCreationService;

import java.util.List;

/**
 * SOAP implementation of the remote EAA creation service
 *
 */
