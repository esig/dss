...
public class PivotInfo extends LOTLInfo {
	...
	private final Map<CertificateToken, CertificatePivotStatus> certificateStatusMap;
	 ...
	 */
	public PivotInfo(final DownloadInfoRecord downloadCacheInfo, final TLParsingInfoRecord parsingCacheInfo,
