 ...
 *
 */
public class VerifiedClaimString extends AbstractVerifiedClaim {
     ...
     */
    public VerifiedClaimString(final String value) {
        this(null, value);
    }
     ...
     * @param value {@link String} value of the claim
     */
    public VerifiedClaimString(final String name, final String value) {
     ...
     */
    public VerifiedClaimString(final String name, final String value, final boolean selectivelyDisclosable) {
     ...
     */
    public VerifiedClaimString(final String name, final String value, final boolean selectivelyDisclosable, final VerifiedClaim parent) {
     ...
     * @param parent {@link VerifiedClaim} representing the parent claim, when applicable
     */
    public VerifiedClaimString(final String name, final String namespace, final String value,
    ...
    public boolean equals(Object o) {
        ...
        VerifiedClaimString that = (VerifiedClaimString) o;
