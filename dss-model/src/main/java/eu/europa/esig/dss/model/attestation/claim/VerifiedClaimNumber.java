 ...
 *
 */
public class VerifiedClaimNumber extends AbstractVerifiedClaim {
     ...
     */
    public VerifiedClaimNumber(final Number value) {
        this(null, value);
    }
     ...
     * @param value {@link String} value of the claim
     */
    public VerifiedClaimNumber(final String name, final Number value) {
     ...
     */
    public VerifiedClaimNumber(final String name, final Number value, final boolean selectivelyDisclosable) {
     ...
     */
    public VerifiedClaimNumber(final String name, final Number value, final boolean selectivelyDisclosable, final VerifiedClaim parent) {
     ...
     * @param parent {@link VerifiedClaim} representing the parent claim, when applicable
     */
    public VerifiedClaimNumber(final String name, final String namespace, final Number value,
    ...
    public boolean equals(Object o) {
        ...
        VerifiedClaimNumber that = (VerifiedClaimNumber) o;
