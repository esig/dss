 ...
 *
 */
public class VerifiedClaimDate extends AbstractVerifiedClaim {
     ...
     */
    public VerifiedClaimDate(final Date value) {
        this(null, value);
    }
     ...
     * @param value {@link Date} value of the claim
     */
    public VerifiedClaimDate(final String name, final Date value) {
     ...
     */
    public VerifiedClaimDate(final String name, final Date value, final boolean selectivelyDisclosable) {
     ...
     */
    public VerifiedClaimDate(final String name, final Date value, final boolean selectivelyDisclosable, final VerifiedClaim parent) {
     ...
     * @param parent {@link VerifiedClaim} representing the parent claim, when applicable
     */
    public VerifiedClaimDate(final String name, final String namespace, final Date value, final boolean selectivelyDisclosable,
                             final VerifiedClaim parent) {
    ...
    public boolean equals(Object o) {
        ...
        VerifiedClaimDate claimDate = (VerifiedClaimDate) o;
