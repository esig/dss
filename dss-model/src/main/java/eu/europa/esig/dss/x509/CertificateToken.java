 ...
 * {@link java.security.cert.X509Certificate} a certificateToken is created.<br>
 * This class encapsulates some frequently used information: a certificate comes
 * from a certain context (Trusted List, CertStore, Signature), has revocation
 * data... To expedite the processing of such information, they are kept in
 * cache.
 */
...
public class CertificateToken extends Token {
    ...
    /**
     * If the certificate is part of the trusted list then the the serviceInfo
     * represents the associated trusted service provider service. Same
     * certificate can be a part of multiple services.
     */
    private Set<ServiceInfo> associatedTSPS = new HashSet<ServiceInfo>();

    /**
     * The default algorithm used to compute the digest value of this
     * certificate
     */
    ...
    /**
     * Indicates if the certificate is self-signed. This attribute stays null
     * till the first call to {@link #isSelfSigned()} function.
     */
    ...
    /**
     * In the case of the XML signature this is the Id associated with the
     * certificate if any.
     */
     ...
     * {@link eu.europa.esig.dss.x509.CertificateToken}.
     *
     ...
     * Each source is present only once.
     *
    ...
    /**
     * Returns a string representation of the unique DSS certificate token
     * identifier.
     */
    ...
    /**
     * @param revocationToken This is the reference to the CertificateStatus.
     * The object type is used because of the organisation of module.
     */
     ...
     * To get the encryption algorithm used with this public key call
     * getAlgorithm() method.<br>
     * RFC 2459:<br>
     * 4.1.2.7 Subject Public Key Info This field is used to carry the public
     * key and identify the algorithm with which the key is used. The algorithm
     * is identified using the AlgorithmIdentifier structure specified in
     * section 4.1.1.2. The object identifiers for the supported algorithms and
     * the methods for encoding the public key materials (public key and
     * parameters) are specified in section 7.3.
     *
     * @return
     */
    ...
    /**
     * Returns the encoded form of this certificate. X.509 certificates would be
    ...
    /**
     * Gets information about the context in which this certificate token was
     * created (TRUSTED_LIST, TRUSTED_STORE, ...). This method does not
     * guarantee that the token is trusted or not.
     *
     * @return
     */
    ...
    /**
     * Gets information about the trusted context of the certificate. See
     * {@link eu.europa.esig.dss.tsl.ServiceInfo} for more information.
     *
     * @return
     */
    ...
    /**
     * Gets the serialNumber value from the encapsulated certificate. The serial
     ...
     * certificate as an X500Principal. If the subject value is empty, then the
     * getName() method of the returned X500Principal object returns an empty
     * string ("").
     *
     * @return
     */
    public X500Principal getSubjectX500Principal() {
        if (subjectX500PrincipalNormalized == null) {
            ...
            subjectX500PrincipalNormalized = x509Certificate.getSubjectX500Principal();
            ;
        }
    ...
    /**
     * Returns the trust anchor associated with the certificate. If it is the
     * self-signed certificate then {@code this} is returned.
     *
     * @return
     */
    ...
    public String toString(String indentStr) {
        try {
            ...
            } else if (!signatureInvalidityReason.isEmpty()) {
    ...
    /**
     * @return return the id associated with the certificate in case of an XML
     * signature, or null
     */
    ...
    /**
     * This method returns a list {@code KeyUsageBit} representing the key
     * usages of the certificate.
     *
     * @return {@code List} of {@code KeyUsageBit}s of different certificate's
     * key usages
     */
