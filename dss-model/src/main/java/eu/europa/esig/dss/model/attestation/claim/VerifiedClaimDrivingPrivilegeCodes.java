 ...
 *
 */
public interface VerifiedClaimDrivingPrivilegeCodes extends VerifiedClaim {

    /**
     * Gets a list of codes
     *
     * @return a list of {@link VerifiedClaimDrivingPrivilegeCode}s
     */
    List<VerifiedClaimDrivingPrivilegeCode> getCodes();
