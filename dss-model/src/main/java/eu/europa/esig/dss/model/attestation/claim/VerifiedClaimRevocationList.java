...
/**
 * Represents a generic attestation revocation list
 *
 */
public interface VerifiedClaimRevocationList extends VerifiedClaim {
     ...
     */
    VerifiedClaimByteString getCertificate();
