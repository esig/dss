 ...
 *
 */
public class VerifiedClaimNull extends AbstractVerifiedClaim {
     ...
     */
    public VerifiedClaimNull(final String name) {
        super(name);
    }
     ...
     */
    public VerifiedClaimNull(final String name, final boolean selectivelyDisclosable) {
     ...
     */
    public VerifiedClaimNull(final String name, final boolean selectivelyDisclosable, final VerifiedClaim parent) {
     ...
     * @param parent {@link VerifiedClaim} representing the parent claim, when applicable
     */
    public VerifiedClaimNull(final String name, final String namespace, final boolean selectivelyDisclosable, final VerifiedClaim parent) {
