...
public enum XAdES111Element implements XAdESElement {
	...
	/** Error message */
	private static final String NOT_SUPPORTED_XADES_111 = "Element not supported by " + XAdESNamespace.XADES_111.getUri();
	...
	XAdES111Element(String tagName) {
		...
		this.namespace = XAdESNamespace.XADES_111;
	}
	...
	public DSSElement getElementAttrAuthoritiesCertValues() {
		throw new UnsupportedOperationException(NOT_SUPPORTED_XADES_111);
	}
