...
1. SignatureService
   http://localhost:8080/dss-webapp/wservice/signatureService exposes three operations:
	- signDocument
	- extendSignature
	- getDataToSign
...
2. ValidationService
   http://localhost:8080/dss-webapp/wservice/validationService exposes one operation:
   - validateDocument
   WSDL information is given via:
...
- http://localhost:8080/dss-webapp/admin/proxy
