...
/**
 * A static utilites that helps in creating ImageAndResolution
 * @author pakeyser
 *
 */
public class ImageUtils {
	...
	public static ImageAndResolution create(final SignatureImageParameters imageParameters) throws IOException {
		...
		if ((textParamaters != null) && StringUtils.isNotEmpty(textParamaters.getText())) {
			...
			BufferedImage buffImg = ImageTextWriter.createTextImage(textParamaters.getText(), textParamaters.getFont(), textParamaters.getTextColor(), textParamaters.getBackgroundColor(), DPI);
