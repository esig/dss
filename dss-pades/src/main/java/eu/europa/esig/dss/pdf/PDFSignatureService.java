...
public interface PDFSignatureService {
	 ...
	 * @deprecated since DSS 5.12. Use {@code #getRevisions(document, pwd.getBytes())}
	 */
	@Deprecated
	 ...
	 * @return list of extracted {@link PdfRevision}s
	 */
	List<PdfRevision> getRevisions(final DSSDocument document, final byte[] pwd);
	 ...
	 * @return the pdf document with the added dss dictionary
	 * @deprecated since DSS 5.12. Use {@code #addDssDictionary(document, validationDataForInclusion, pwd.getBytes())}
	 */
	@Deprecated
	DSSDocument addDssDictionary(final DSSDocument document, final PdfValidationDataContainer validationDataForInclusion,
								 final String pwd);
	 ...
	 * @deprecated since DSS 5.12. Use {@code #getAvailableSignatureFields(document, pwd.getBytes())}
	 */
	@Deprecated
	 ...
	 * @return the list of not signed signature field names
	 */
	List<String> getAvailableSignatureFields(final DSSDocument document, final byte[] pwd);
	 ...
	 *            the password protection used to create the encrypted document (optional)
	 * @return the pdf document with the new added signature field
	 * @deprecated since DSS 5.12. Use {@code #addNewSignatureField(document, parameters, pwd.getBytes())}
	 */
	@Deprecated
	DSSDocument addNewSignatureField(final DSSDocument document, final SignatureFieldParameters parameters,
									 final String pwd);
	 ...
	 * @deprecated since DSS 5.12. Use {@code #analyzePdfModifications(document, signatures, pwd.getBytes())}
	 */
	@Deprecated
	 ...
	 * @param pwd         {@link String} password protection
	 */
	void analyzePdfModifications(final DSSDocument document, final List<AdvancedSignature> signatures, final byte[] pwd);
