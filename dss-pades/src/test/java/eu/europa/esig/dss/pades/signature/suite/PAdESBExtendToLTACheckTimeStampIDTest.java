...
public class PAdESBExtendToLTACheckTimeStampIDTest extends PKIFactoryAccess {

	@Test
	public void test() throws Exception {
		DSSDocument documentToSign = new InMemoryDocument(PAdESBExtendToLTACheckTimeStampIDTest.class.getResourceAsStream("/sample.pdf"));
