...
public class PdfPkcs7 {
	...
	public void test() throws Exception {
		...
		assertEquals(0, signatureById.getFoundCertificatesByRefLocation(CertificateRefLocationType.SIGNING_CERTIFICATE).size());
		assertEquals(4, signatureById.getFoundCertificateIds(CertificateOriginType.KEY_INFO).size());
