...
public abstract class AbstractPAdESCMSGeneratorServiceTest extends AbstractPAdESTestSignature {
    ...
    private byte[] getSignedCMSignedData(byte[] documentDigest) {
        ...
        Digest messageDigest = new Digest(signatureParameters.getDigestAlgorithm(), documentDigest);
        CMSForPAdESGenerationService cmsForPAdESGenerationService = new CMSForPAdESGenerationService(getOfflineCertificateVerifier());
        ToBeSigned dataToSign = cmsForPAdESGenerationService.getDataToSign(messageDigest, signatureParameters);

        SignatureValue signatureValue = getToken().sign(dataToSign, signatureParameters.getDigestAlgorithm(), getPrivateKeyEntry());

        // stateless
        cmsForPAdESGenerationService = new CMSForPAdESGenerationService(getOfflineCertificateVerifier());
        CMSSignedDocument cmsSignedDocument = cmsForPAdESGenerationService.getCMSSignature(messageDigest, signatureParameters, signatureValue);
