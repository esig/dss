...
public class PAdESLevelBDetachedDigestDocumentTest extends PKIFactoryAccess {
	...
	private PAdESService getService() {
		PAdESService service = new PAdESService(getCompleteCertificateVerifier());
		service.setTspSource(getGoodTsa());
		return service;
	}

	private PAdESSignatureParameters getParams() {
	...
	private PAdESSignatureParameters getExtendParams() {
		PAdESSignatureParameters signatureParameters = new PAdESSignatureParameters();
