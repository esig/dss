...
public class GetOriginalDocument extends PKIFactoryAccess {
	...
	public final void getOriginalDocument() throws Exception {
		...
		LOG.info("ORIGINAL : {}", document.getDigest64Base(DigestAlgorithm.SHA256));
		LOG.info("RETRIEVED : {}", retrievedSignedDocument.getDigest64Base(DigestAlgorithm.SHA256));

		assertEquals(document.getDigest64Base(DigestAlgorithm.SHA256), retrievedSignedDocument.getDigest64Base(DigestAlgorithm.SHA256));
		...
		LOG.info("SIGNED ORIGINAL : {}", signedDocument.getDigest64Base(DigestAlgorithm.SHA256));
		LOG.info("SIGNED RETRIEVED : {}", retrievedResignedDocument.getDigest64Base(DigestAlgorithm.SHA256));

		assertEquals(signedDocument.getDigest64Base(DigestAlgorithm.SHA256), retrievedResignedDocument.getDigest64Base(DigestAlgorithm.SHA256));
	}
