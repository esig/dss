...
class PAdESLevelLTAWithOrphanRefsWithXmlEvidenceRecordValidationTest extends AbstractPAdESWithEvidenceRecordTestValidation {
    ...
    protected List<DSSDocument> getDetachedEvidenceRecords() {
        return Collections.singletonList(new InMemoryDocument(getClass().getResourceAsStream("/validation/evidence-record/evidence-record-Signature-P-HU_POL-7.xml")));
    }
    ...
    protected void checkEvidenceRecordTimestampedReferences(DiagnosticData diagnosticData) {
        ...
        assertEquals(2, evidenceRecordWrapper.getCoveredSignatures().size());
        assertEquals(4, evidenceRecordWrapper.getCoveredTimestamps().size());
        assertEquals(11, evidenceRecordWrapper.getCoveredCertificates().size());
        assertEquals(3, evidenceRecordWrapper.getCoveredOrphanCertificates().size());
        assertEquals(2, evidenceRecordWrapper.getCoveredRevocations().size());
        assertEquals(5, evidenceRecordWrapper.getCoveredOrphanRevocations().size());
