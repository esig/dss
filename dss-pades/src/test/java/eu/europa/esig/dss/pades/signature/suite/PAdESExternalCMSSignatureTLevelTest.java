...
class PAdESExternalCMSSignatureTLevelTest extends AbstractPAdESTestSignature {
    ...
    protected DSSDocument sign() {
        ...
        DSSMessageDigest documentDigest = service.getMessageDigest(documentToSign, signatureParameters);
        assertNotNull(documentDigest);

        // Embedded CAdES is generated by a third party
        DSSDocument cmsSignedData = getSignedCMSignedData(documentDigest);
