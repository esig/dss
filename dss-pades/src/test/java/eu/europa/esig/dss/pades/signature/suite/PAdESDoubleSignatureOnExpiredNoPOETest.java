...
// See DSS-3592
class PAdESDoubleSignatureOnExpiredNoPOETest extends AbstractPAdESTestSignature {
    ...
    void init() throws Exception {
        ...
        originalDocument = new InMemoryDocument(PAdESDoubleSignatureOnExpiredNoPOETest.class.getResourceAsStream("/sample.pdf"));
