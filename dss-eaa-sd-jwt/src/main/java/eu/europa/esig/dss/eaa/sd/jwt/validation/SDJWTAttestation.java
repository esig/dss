...
public class SDJWTAttestation extends DefaultAttestation {
    ...
    /**
     * This class is used to build a {@code eu.europa.esig.dss.eaa.jwt.validation.SDJWTAttestation} object
     *
     */
    public static class SDJWTAttestationBuilder extends DefaultAttestationBuilder {
        ...
        @Override
        public SDJWTAttestationBuilder setDisclosures(List<ValidationDisclosure> disclosures) {
