...
class ASiCSXAdESDoubleSignatureOnExpiredWithPOETest extends AbstractASiCSXAdESTestSignature {
    ...
    protected void checkSignatureLevel(DiagnosticData diagnosticData) {
        ...
        for (SignatureWrapper signatureWrapper : diagnosticData.getSignatures()) {
            if (SignatureLevel.XAdES_BASELINE_T == signatureWrapper.getSignatureFormat()) {
                ++tLevelCounter;
