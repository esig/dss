...
public class ASiCSXAdESMultipleCounterSignaturesTest extends AbstractASiCWithXAdESTestValidation {
	...
	public void test() throws Exception {
		...
		// secondCounterSignedDocument.save("target/secondCounterSignedDocument.scs");
		...
		// thirdCounterSignedDocument.save("target/thirdCounterSignedDocument.scs");
		...
		assertEquals(1, containerInfo.getContentFiles().size());
		assertEquals("package.zip", containerInfo.getContentFiles().get(0));
