...
public class ASiCEWithXAdESLevelBContainerMergerDifferentFileContentTest extends AbstractWithXAdESTestMerge {
    ...
    public void init() {
        ...
        documentToSignTwo = new InMemoryDocument("Bye World!".getBytes(), "hello.txt", MimeTypeEnum.TEXT);
