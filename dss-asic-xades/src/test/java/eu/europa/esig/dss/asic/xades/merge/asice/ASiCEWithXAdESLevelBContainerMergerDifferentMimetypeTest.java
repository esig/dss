...
public class ASiCEWithXAdESLevelBContainerMergerDifferentMimetypeTest extends AbstractWithXAdESTestMerge {
    ...
    public void init() {
        ...
        secondSignatureParameters.aSiC().setMimeType(MimeTypeEnum.ASICE.getMimeTypeString());
