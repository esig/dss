...
public class ArchiveTimeStampCheckTest extends AbstractTestCheck {
    ...
    public void valid() {
        ...
        ArchiveTimeStampCheck atsc = new ArchiveTimeStampCheck(i18nProvider, result, new SignatureWrapper(sig), constraint);
        atsc.execute();
