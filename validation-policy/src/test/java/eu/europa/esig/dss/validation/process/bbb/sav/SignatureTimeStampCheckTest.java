...
public class SignatureTimeStampCheckTest extends AbstractTestCheck {
    ...
    public void valid() {
        ...
        SignatureTimeStampCheck stsc = new SignatureTimeStampCheck(i18nProvider, result, new SignatureWrapper(sig), constraint);
        stsc.execute();
