 ...
 *
 */
public class GrantedStatusAtProductionTimeCheck<T extends XmlConstraintsConclusion> extends ChainItem<T> {
	 ...
	 */
	public GrantedStatusAtProductionTimeCheck(I18nProvider i18nProvider, T result,
