...
public enum MessageTag {
	...
	BBB_XCV_IRDPFC("Is there a satisfying revocation status information ?"),
	BBB_XCV_IRDPFC_ANS("No satisfying revocation status information found for the certificate"),
