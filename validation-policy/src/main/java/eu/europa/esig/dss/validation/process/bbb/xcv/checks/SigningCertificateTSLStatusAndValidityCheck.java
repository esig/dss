...
public class SigningCertificateTSLStatusAndValidityCheck extends ChainItem<XmlXCV> {

	private final CertificateWrapper certificate;

	public SigningCertificateTSLStatusAndValidityCheck(XmlXCV result, CertificateWrapper certificate, LevelConstraint constraint) {
