...
public class CertificateCryptographicCheck extends ChainItem<XmlXCV> {

	private static final Logger logger = LoggerFactory.getLogger(CertificateCryptographicCheck.class);
