...
public class CertificateOnHoldCheck extends ChainItem<XmlXCV> {

	private final CertificateWrapper certificate;

	public CertificateOnHoldCheck(XmlXCV result, CertificateWrapper certificate, LevelConstraint constraint) {
