...
/**
 * This class encapsulates the constraint file that controls the policy to be used during the validation process. This is the base class used to implement a
...
public interface ValidationPolicy {
	...
	/**
	 * Indicates if the signature policy should be checked. If AcceptablePolicies element is absent within the constraint file then null is returned, otherwise
	...
	/**
	 * Indicates if the signed property: content-identifier should be checked. If ContentIdentifier element is absent within the constraint file then null is
	 * returned.
	 *
	...
	/**
	 * Indicates if the signed property: commitment-type-indication should be checked. If CommitmentTypeIndication element is absent within the constraint file
	...
	/**
	 * Indicates if the signed property: signer-location should be checked. If SignerLocation element is absent within the constraint file then null is
	 * returned.
	 *
	...
	/**
	 * Indicates if the signed property: content-time-stamp should be checked. If ContentTimeStamp element is absent within the constraint file then null is
	 * returned.
	 *
	...
	/**
	 * This method creates the {@code SignatureCryptographicConstraint} corresponding to the context parameter. If AcceptableEncryptionAlgo is not present in
	 ...
	 * @return {@code SignatureCryptographicConstraint} if AcceptableEncryptionAlgo for a given context element is present in the constraint file, null
	 *         otherwise.
	 */
	...
	/**
	 * Indicates if the end user certificate used in validating the signature is mandated to be supported by a secure signature creation device (SSCD) as
