...
public enum MessageTag implements IMessageTag {
	...
	/* BBB -> FC */
	BBB_FC_IEFF("Is the signature conformant to the (an) expected format(s)?"),
	BBB_FC_IEFF_ANS("The signature is not conformant to the (an) expected format(s)!"),
	...
	BBB_FC_IECTF("Is the container conformant to the (an) expected type(s)?"),
	...
	BBB_FC_ITEZCF("Does the zip file comment contain an expected value?"),
	BBB_FC_ITEZCF_ANS("The zip file comment does not contain an expected value!"),
	
	BBB_FC_ITMFP("Is the mimetype file present?"),
	BBB_FC_ITMFP_ANS("The mimetype file is absent!"),
	
	BBB_FC_IEMCF("Does the mimetype file content comply with its expected value(s)?"),
	BBB_FC_IEMCF_ANS("The mimetype file content doesn't comply with its expected value(s)!"),
	...
	/* BBB -> CV */
	BBB_CV_IRDOF("Is the reference data object present?"),
	...
	BBB_ICS_ICDVV("Is the certificate digest value valid?"),
	...
	ASCCM_ANS_4("The algorithm expiration date was not found!"),
	...
	BBB_VCI_ISPM("Does the signature policy's hash match?"),
	...
	BBB_XCV_CCCBB_ANS("The certificate chain is not trusted, it doesn't contain any trust anchor."),
	BBB_XCV_CCCBB_SIG_ANS("The certificate chain for signature is not trusted, it doesn't contain any trust anchor."),
	BBB_XCV_CCCBB_TSP_ANS("The certificate chain for timestamp is not trusted, it doesn't contain any trust anchor."),
	BBB_XCV_CCCBB_REV_ANS("The certificate chain for revocation data is not trusted, it doesn't contain any trust anchor."),
	BBB_XCV_CMDCIPI("Certificate meta-data constraints: Does it contain one of the required policy ids?"),
	BBB_XCV_CMDCIPI_ANS("None of the required policy ids were found in the certificate"),
	BBB_XCV_CMDCIQCS("Certificate meta-data constraints: Does it contain one of the required QC Statement ids?"),
	BBB_XCV_CMDCIQCS_ANS("None of the required QC Statement ids were found in the certificate."),
	BBB_XCV_CMDCIITLP("Certificate meta-data constraints: Was it issued to a legal person?"),
	BBB_XCV_CMDCIITLP_ANS("The certificate was not issued to a legal person."),
	BBB_XCV_CMDCIITNP("Certificate meta-data constraints: Was it issued to a natural person?"),
	BBB_XCV_CMDCIITNP_ANS("The certificate was not issued to a natural person."),
	...
	BBB_XCV_IRIF("Is the revocation information for the certificate considered as fresh?"),
	...
	BBB_XCV_ISCGKU("Does the signer's certificate have the expected key-usage(s)?"),
	BBB_XCV_ISCGKU_ANS("The signer's certificate doesn't have any expected key-usage!"),
	BBB_XCV_ISCGEKU("Does the signer's certificate have the expected 'extended key-usage(s)'?"),
	BBB_XCV_ISCGEKU_ANS("The signer's certificate doesn't have any expected 'extended key-usage'!"),
	BBB_XCV_ICSI("Is the certificate signature intact?"),
	BBB_XCV_ICSI_ANS("The signature of the certificate is either corrupted or it is not possible to process its validatation!"),
	...
	BBB_XCV_ISCGCOUN("Does the certificate subject name have a country-name attribute?"),
	BBB_XCV_ISCGCOUN_ANS("The certificate subject name is not expected to be missing the country-name attribute!"),
	BBB_XCV_ISCGORGAN("Does the certificate subject name have an organization name attribute?"),
	BBB_XCV_ISCGORGAN_ANS("The certificate subject name is not expected to be missing the organization name attribute!"),
	BBB_XCV_ISCGORGAU("Does the certificate subject name have an organization unit attribute?"),
	BBB_XCV_ISCGORGAU_ANS("The certificate subject name is not expected to be missing the organization unit attribute!"),
	BBB_XCV_ISCGSURN("Does the certificate subject name have surname attribute?"),
	BBB_XCV_ISCGSURN_ANS("The certificate subject name is not expected to be missing the surname attribute!"),
	BBB_XCV_ISCGGIVEN("Does the certificate subject name have a 'given name' attribute?"),
	BBB_XCV_ISCGGIVEN_ANS("The certificate subject name is not expected to be missing the 'given name' attribute!"),
	BBB_XCV_ISCGPSEUDO("Does the certificate subject name have a pseudonym attribute?"),
	BBB_XCV_ISCGPSEUDO_ANS("The certificate subject name is not expected to be missing the pseudonym attribute!"),
	BBB_XCV_ISCGCOMMONN("Does the certificate subject name have a common name attribute?"),
	BBB_XCV_ISCGCOMMONN_ANS("The certificate subject name is not expected to be missing the common name attribute!"),
	...
	XCV_TSL_ESP_ANS("The trust service does not have the expected status!"),
	XCV_TSL_ESP_SIG_ANS("The trust service related to the signing certificate has not the expected status!"),
	XCV_TSL_ESP_TSP_ANS("The trust service related to the timestamp has not the expected status!"),
	XCV_TSL_ESP_REV_ANS("The trust service related to the revocation has not expected status!"),
	XCV_TSL_ETIP("Is the expected trust service type identifier present?"),
	XCV_TSL_ETIP_ANS("The trust service does not have the expected type identifier!"),
	XCV_TSL_ETIP_SIG_ANS("The trust service related to the signing certificate has not the expected type identifier!"),
	XCV_TSL_ETIP_TSP_ANS("The trust service related to the timestamp has not expected the type identifier!"),
	XCV_TSL_ETIP_REV_ANS("The trust service related to the revocation has not the expected type identifier!"),

	PCV_IVTSC("Is the validation time sliding conclusive?"),
	PCV_IVTSC_ANS("The indications returned by validation time sliding sub-process."),

	PSV_IPCVA("Is the certificate retro-validation acceptable?"),
	PSV_IPCVA_ANS("The certificate retro-validation is not acceptable!"),
	PSV_IPCVC("No POE, what is the current time validation?"),
	PSV_IPCVC_ANS("The current time validation is not conclusive!"),
	PSV_IPSVC("Is the signature retro-validation conclusive?"),
	PSV_IPSVC_ANS("The signature retro-validation is not conclusive!"),
	PSV_IPTVC("Is the timestamp retro-validation conclusive?"),
	PSV_IPTVC_ANS("The timestamp retro-validation is not conclusive!"),
	...
	TSV_ISCNVABST("Is the signing certificate not valid at best-signature-time?"),
	TSV_ISCNVABST_ANS("The signing certificate retro-validation must be performed!"),

	ADEST_IRTPTBST("Is the revocation time posterior to best-signature-time?"),
	ADEST_IRTPTBST_ANS("The revocation time is not posterior to best-signature-time!"),
	ADEST_VFDTAOCST_ANS("The validation failed due to the absence of the claimed signing time!"),
	...
	QUAL_TL_EXP("Has the signing-certificate of the trusted list expired?"),
	QUAL_TL_EXP_ANS("The signing-certificate of the trusted list has expired!"),
	...
	QUAL_TL_VERSION_ANS("The trusted list doesn't have the expected version!"),
	...
	QUAL_QSCD_AT_ST_ANS("The private key doesn't reside in a QSCD at (best) signing time!"),
	QUAL_QSCD_AT_CC("Does the private key reside in a QSCD at issuance time?"),
	QUAL_QSCD_AT_CC_ANS("The private key doesn't reside in a QSCD at issuance time!"),
	QUAL_QSCD_AT_VT("Does the private key reside in a QSCD at validation time?"),
	QUAL_QSCD_AT_VT_ANS("The private key doesn't reside in a QSCD at validation time!"),
	...
	QUAL_HAS_CERT_TYPE_COVERAGE("Can the certificate type be issued by (one of) the trust service(s) found?"),
	QUAL_HAS_CERT_TYPE_COVERAGE_ANS("The certificate type cannot be issued by (one of) the trust service(s) found!"),

	QUAL_HAS_ONLY_ONE("Is the qualification conclusion unambiguous?"),
