...
public enum MessageTag implements IMessageTag {
	...
	BBB_CV_IMEOF("Is the manifest entry object found?"),
	BBB_CV_IMEOF_ANS("The manifest entry object is not found!"),
	BBB_CV_IMEOI("Is the manifest entry object intact?"),
	BBB_CV_IMEOI_ANS("The manifest entry object is not intact!"),
