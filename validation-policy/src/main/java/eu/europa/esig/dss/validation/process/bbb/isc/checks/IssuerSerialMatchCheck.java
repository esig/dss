...
public class IssuerSerialMatchCheck extends ChainItem<XmlISC> {
	...
	public IssuerSerialMatchCheck(I18nProvider i18nProvider, XmlISC result, CertificateRefWrapper signingCertificateRef, LevelConstraint constraint) {
	...
	protected boolean process() {
		return signingCertificateRef.isIssuerSerialMatch();
	}
