...
public class QualificationByTL implements QualificationStrategy {
	...
	private final XmlTrustedService trustedService;
	private final CertificateWrapper signingCertificate;
	private final QualifiedStatus qualifiedStatusFromCert;

	public QualificationByTL(XmlTrustedService trustedService, CertificateWrapper signingCertificate, QualifiedStatus qualifiedStatusFromCert) {
