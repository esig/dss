...
// Generated on: 2019.04.02 at 09:59:18 AM CEST 
//
...
public class XmlTimestamp implements Serializable
{
    ...
    @XmlElements({
        @XmlElement(name = "TimestampedCertificate", type = XmlTimestampedCertificate.class, namespace = "http://dss.esig.europa.eu/validation/diagnostic"),
        @XmlElement(name = "TimestampedRevocationData", type = XmlTimestampedRevocationData.class, namespace = "http://dss.esig.europa.eu/validation/diagnostic"),
        @XmlElement(name = "TimestampedTimestamp", type = XmlTimestampedTimestamp.class, namespace = "http://dss.esig.europa.eu/validation/diagnostic"),
        @XmlElement(name = "TimestampedSignature", type = XmlTimestampedSignature.class, namespace = "http://dss.esig.europa.eu/validation/diagnostic")
    })
