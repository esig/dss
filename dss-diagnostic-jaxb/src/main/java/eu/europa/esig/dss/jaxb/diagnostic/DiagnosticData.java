 ...
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType"&gt;
 *                 &lt;sequence&gt;
 *                   &lt;element name="SignedData" type="{http://dss.esig.europa.eu/validation/diagnostic}SignedData" maxOccurs="unbounded" minOccurs="0"/&gt;
 *                 &lt;/sequence&gt;
 *               &lt;/restriction&gt;
 *             &lt;/complexContent&gt;
 *           &lt;/complexType&gt;
...
public class DiagnosticData implements Serializable
{
    ...
    @XmlElement(name = "SignedData", namespace = "http://dss.esig.europa.eu/validation/diagnostic")
    protected List<XmlSignedData> originalDocuments;
    ...
    public List<XmlSignedData> getOriginalDocuments() {
        if (originalDocuments == null) {
            originalDocuments = new ArrayList<XmlSignedData>();
        }
        return originalDocuments;
    }

    public void setOriginalDocuments(List<XmlSignedData> originalDocuments) {
