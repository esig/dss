 ...
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType"&gt;
 *                 &lt;sequence&gt;
 *                   &lt;element name="OrphanToken" type="{http://dss.esig.europa.eu/validation/diagnostic}OrphanToken" maxOccurs="unbounded" minOccurs="0"/&gt;
 *                 &lt;/sequence&gt;
 *               &lt;/restriction&gt;
 *             &lt;/complexContent&gt;
 *           &lt;/complexType&gt;
...
public class DiagnosticData implements Serializable
{
    ...
    @XmlElementWrapper(name = "OrphanTokens")
    @XmlElement(name = "OrphanToken", namespace = "http://dss.esig.europa.eu/validation/diagnostic")
    ...
    public List<XmlOrphanToken> getOrphanTokens() {
        if (orphanTokens == null) {
            orphanTokens = new ArrayList<XmlOrphanToken>();
        }
        return orphanTokens;
    }
