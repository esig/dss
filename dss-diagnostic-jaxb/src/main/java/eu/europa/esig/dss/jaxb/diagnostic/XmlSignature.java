 ...
 *           &lt;/complexType&gt;
 *         &lt;/element&gt;
 *         &lt;element name="RevocationRefs" minOccurs="0"&gt;
 *           &lt;complexType&gt;
 *             &lt;complexContent&gt;
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType"&gt;
 *                 &lt;sequence&gt;
...
public class XmlSignature implements Serializable
{
    ...
    @XmlElementWrapper(name = "RevocationRefs")
    ...
    public void setRevocationRefs(List<XmlRevocationRef> revocationRefs) {
        this.revocationRefs = revocationRefs;
    }
