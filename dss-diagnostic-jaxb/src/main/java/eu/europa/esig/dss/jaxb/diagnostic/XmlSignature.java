 ...
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType"&gt;
 *                 &lt;sequence&gt;
 *                   &lt;element name="CertificateRevocationRef" type="{http://dss.esig.europa.eu/validation/diagnostic}CertificateRevocationRef" maxOccurs="unbounded" minOccurs="0"/&gt;
 *                 &lt;/sequence&gt;
 *               &lt;/restriction&gt;
 *             &lt;/complexContent&gt;
 *           &lt;/complexType&gt;
 ...
 *           &lt;/complexType&gt;
 *         &lt;/element&gt;
 *         &lt;element name="FoundRevocationRefs" minOccurs="0"&gt;
 *           &lt;complexType&gt;
 *             &lt;complexContent&gt;
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType"&gt;
 *                 &lt;sequence&gt;
 *                   &lt;element name="FoundRevocationRef" type="{http://dss.esig.europa.eu/validation/diagnostic}FoundRevocationRef" maxOccurs="unbounded" minOccurs="0"/&gt;
 *                 &lt;/sequence&gt;
 *               &lt;/restriction&gt;
 *             &lt;/complexContent&gt;
 *           &lt;/complexType&gt;
...
public class XmlSignature implements Serializable
{
    ...
    @XmlElement(name = "CertificateRevocationRef", namespace = "http://dss.esig.europa.eu/validation/diagnostic")
    protected List<XmlCertificateRevocationRef> relatedRevocations;
    ...
    @XmlElementWrapper(name = "FoundRevocationRefs")
    @XmlElement(name = "FoundRevocationRef", namespace = "http://dss.esig.europa.eu/validation/diagnostic")
    protected List<XmlFoundRevocationRef> foundRevocationRefs;
    ...
    public List<XmlCertificateRevocationRef> getRelatedRevocations() {
        if (relatedRevocations == null) {
            relatedRevocations = new ArrayList<XmlCertificateRevocationRef>();
        }
        return relatedRevocations;
    }

    public void setRelatedRevocations(List<XmlCertificateRevocationRef> relatedRevocations) {
    ...
    public List<XmlFoundRevocationRef> getFoundRevocationRefs() {
        if (foundRevocationRefs == null) {
            foundRevocationRefs = new ArrayList<XmlFoundRevocationRef>();
        }
        return foundRevocationRefs;
    }

    public void setFoundRevocationRefs(List<XmlFoundRevocationRef> foundRevocationRefs) {
        this.foundRevocationRefs = foundRevocationRefs;
    }
