...
public class XmlSignature implements Serializable
{
    ...
    @XmlElementWrapper(name = "FoundRevocations")
    @XmlElement(name = "RelatedRevocation", namespace = "http://dss.esig.europa.eu/validation/diagnostic")
    protected List<XmlRelatedRevocation> foundRevocations;
    ...
    public List<XmlRelatedRevocation> getFoundRevocations() {
        if (foundRevocations == null) {
            foundRevocations = new ArrayList<XmlRelatedRevocation>();
        }
        return foundRevocations;
    }

    public void setFoundRevocations(List<XmlRelatedRevocation> foundRevocations) {
