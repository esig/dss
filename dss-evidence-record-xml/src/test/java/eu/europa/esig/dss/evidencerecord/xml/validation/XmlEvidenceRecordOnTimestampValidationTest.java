...
public class XmlEvidenceRecordOnTimestampValidationTest extends AbstractDocumentTestValidation {
    ...
    protected List<DSSDocument> getDetachedEvidenceRecords() {
        return Collections.singletonList(new FileDocument("src/test/resources/er-on-tst.xml"));
    }
