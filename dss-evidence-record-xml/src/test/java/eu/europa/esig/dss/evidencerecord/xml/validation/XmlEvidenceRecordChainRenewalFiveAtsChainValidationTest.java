...
class XmlEvidenceRecordChainRenewalFiveAtsChainValidationTest extends AbstractEvidenceRecordTestValidation {

    @Override
    protected DSSDocument getSignedDocument() {
        return new FileDocument("src/test/resources/er-chain-renewal-five-atschain.xml");
    }
    ...
    protected void checkEvidenceRecordTimestamps(DiagnosticData diagnosticData) {
        ...
        assertEquals(5, evidenceRecordWrapper.getTimestampList().size());
    }
