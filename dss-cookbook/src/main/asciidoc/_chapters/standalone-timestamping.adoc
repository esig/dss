...
!!! TODO: add an example TimestampContainerTest.java !!!

[source,java,indent=0]
.Timestamping with a container
----
include::{sourcetestdir}/eu/europa/esig/dss/cookbook/example/timestamp/TimestampContainerTest.java[tags=creation]
----
