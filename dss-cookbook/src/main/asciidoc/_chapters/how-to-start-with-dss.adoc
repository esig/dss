...
'''
dss-attestation-creation-dto:: Data Transfer Objects used for attestation and/or EAAP creation.
dss-attestation-creation-remote:: Common classes between dss-attestation-creation-rest and dss-attestation-creation-soap.
dss-attestation-creation-rest-client:: Client for the REST attestation and/or EAAP creation webservice.
dss-attestation-creation-soap-client:: Client for the SOAP attestation and/or EAAP creation webservice.
dss-attestation-creation-rest:: REST webservice to create attestation and/or EAAP.
dss-attestation-creation-soap:: SOAP webservice to create attestation and/or EAAP.
