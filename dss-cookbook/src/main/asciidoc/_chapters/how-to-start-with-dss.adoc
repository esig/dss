...
dss-attestation:: Common code and interfaces for attestation.
dss-sd-jwt:: Code for creation and validation of attestations based on JWTs (i.e. SD-JWT VC, etc.).
dss-mdoc:: Code for creation and validation of attestations based on mdoc specification as per ISO 18013-5.
dss-attestation-revocation:: Common code and interfaces for attestation revocation.
dss-attestation-revocation-jwt:: Code for the validation of attestation based on JWT tokens.
dss-attestation-revocation-cwt:: Code for the validation of attestation based on CWT tokens.
...
'''
dss-attestation-creation-dto:: Data Transfer Objects used for attestation (e.g. EAA, PID, etc.) and/or presentation (e.g. EAAP) creation.
dss-attestation-creation-remote:: Common classes between dss-attestation-creation-rest and dss-attestation-creation-soap.
dss-attestation-creation-rest-client:: Client for the REST attestation and/or presentation creation webservice.
dss-attestation-creation-soap-client:: Client for the SOAP attestation and/or presentation creation webservice.
dss-attestation-creation-rest:: REST webservice to create attestation and/or presentation.
dss-attestation-creation-soap:: SOAP webservice to create attestation and/or presentation.

'''
dss-attestation-validation-dto:: Data Transfer Objects used for attestation validation (REST and SOAP).
dss-attestation-validation-common:: Common classes between dss-attestation-validation-rest and dss-attestation-validation-soap.
dss-attestation-validation-rest-client:: Client for the REST attestation validation webservices.
dss-attestation-validation-soap-client:: Client for the SOAP attestation validation webservices.
dss-attestation-validation-rest:: REST webservices to validate an attestation.
dss-attestation-validation-soap:: SOAP webservices to validate an attestation.
