...
* Java 8 and higher (tested up to Java 18) is required;
...
In order to build a bundle for JDK 18, the following profile can be used from the `dss-demo-bundle` module:

----
mvn clean install -P java18
----
