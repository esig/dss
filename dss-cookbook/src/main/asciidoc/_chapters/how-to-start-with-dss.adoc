...
dss-attestation:: Common code and interfaces for EAA.
dss-sd-jwt:: Code for creation and validation of EAAs based on JWTs (i.e. SD-JWT VC, etc.).
dss-mdoc:: Code for creation and validation of EAAs based on mdoc specification as per ISO 18013-5.
