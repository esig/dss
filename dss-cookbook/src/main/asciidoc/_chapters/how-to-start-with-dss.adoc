...
* Java 17 or higher (tested up to Java 25) is required;
...
NOTE: By default, the `dss-demo-bundle` module will create a bundle with embedded JDK 25. For other possibilities, please see options below in this section.
