...
In order to generate https://ec.europa.eu/cefdigital/DSS/webapp-demo/apidocs/index.html[HTML Javadoc], you will need to build the DSS Core completely.
...
In order to build a bundle for JDK 16, the following profile can be used from the `dss-demo-bundle` module:
