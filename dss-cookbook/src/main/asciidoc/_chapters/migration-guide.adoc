...
Image is re-sized relatively the PDF document's DPI.
                                                                     a|
Image is created keeping the original dimensions.

Please see the corresponding item in the <<FAQ>> for more information.
