...
|===
|Title                               |v6.2                            |v6.3
|Default validation process requires the `dss-policy-jaxb` module           a|
[source,xml]
.pom.xml
----
<dependencies>
...
|CAdES/PAdES signature and validation (see <<dssCms>>)             a|
[source,xml]
.pom.xml
----
<dependencies>
...
|Old `CMSUtils` moved to `CAdESUtils`             a|
[source,java]
----
...
|`CAdESSignatureExtension` and related classes             a|
[source,java]
----
...
|Min and Max signature extension times             a|
[source,java]
----
