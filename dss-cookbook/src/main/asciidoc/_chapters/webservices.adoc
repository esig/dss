...
* *Signature webservices* (`dss-signature-soap` / `dss-signature-rest`) and their clients: expose methods to allow signing and extending or counter-signing a signature from a client.
* *Server-signing webservice* (`dss-server-signing-soap` / `dss-server-signing-rest`) and their clients: expose methods to retrieve keys from a server (PKCS#11, PKCS#12, HSM,...) and to sign the digest on the server side.
...
* *JSON*: https://github.com/esig/dss/blob/master/dss-cookbook/src/main/asciidoc/_restdocs/sign-digest-document-remotely/3/request-body.adoc[Request] | https://github.com/esig/dss/blob/master/dss-cookbook/src/main/asciidoc/_restdocs/sign-digest-document-remotely/3/response-body.adoc[Response]
* *HTTP*: https://github.com/esig/dss/blob/master/dss-cookbook/src/main/asciidoc/_restdocs/sign-digest-document-remotely/3/http-request.adoc[Request] | https://github.com/esig/dss/blob/master/dss-cookbook/src/main/asciidoc/_restdocs/sign-digest-document-remotely/3/http-response.adoc[Response]
* *HTTPie*: https://github.com/esig/dss/blob/master/dss-cookbook/src/main/asciidoc/_restdocs/sign-digest-document-remotely/3/httpie-request.adoc[Request]
* *Curl*: https://github.com/esig/dss/blob/master/dss-cookbook/src/main/asciidoc/_restdocs/sign-digest-document-remotely/3/curl-request.adoc[Request]
