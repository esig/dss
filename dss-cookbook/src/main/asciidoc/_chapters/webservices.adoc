...
[[RestEAACreationService]]
==== REST attestation creation service

This service implements a creation of attestations, as well as issuance of attestation presentations.

[source,java,indent=0]
.Rest attestation creation service
----
include::{sourcetestdir}/eu/europa/esig/dss/cookbook/example/snippets/ws/rest/RestAttestationCreationServiceSnippet.java[tags=demo]
----
...
* *JSON*: https://github.com/esig/dss/blob/master/dss-cookbook/src/main/asciidoc/_restdocs/attestation-and-attestation-presentation/1/request-body.adoc[Request] | https://github.com/esig/dss/blob/master/dss-cookbook/src/main/asciidoc/_restdocs/attestation-and-attestation-presentation/1/response-body.adoc[Response]
* *HTTP*: https://github.com/esig/dss/blob/master/dss-cookbook/src/main/asciidoc/_restdocs/attestation-and-attestation-presentation/1/http-request.adoc[Request] | https://github.com/esig/dss/blob/master/dss-cookbook/src/main/asciidoc/_restdocs/attestation-and-attestation-presentation/1/http-response.adoc[Response]
* *HTTPie*: https://github.com/esig/dss/blob/master/dss-cookbook/src/main/asciidoc/_restdocs/attestation-and-attestation-presentation/1/httpie-request.adoc[Request]
* *Curl*: https://github.com/esig/dss/blob/master/dss-cookbook/src/main/asciidoc/_restdocs/attestation-and-attestation-presentation/1/curl-request.adoc[Request]
...
* *JSON*: https://github.com/esig/dss/blob/master/dss-cookbook/src/main/asciidoc/_restdocs/attestation-and-attestation-presentation/2/request-body.adoc[Request] | https://github.com/esig/dss/blob/master/dss-cookbook/src/main/asciidoc/_restdocs/attestation-and-attestation-presentation/2/response-body.adoc[Response]
* *HTTP*: https://github.com/esig/dss/blob/master/dss-cookbook/src/main/asciidoc/_restdocs/attestation-and-attestation-presentation/2/http-request.adoc[Request] | https://github.com/esig/dss/blob/master/dss-cookbook/src/main/asciidoc/_restdocs/attestation-and-attestation-presentation/2/http-response.adoc[Response]
* *HTTPie*: https://github.com/esig/dss/blob/master/dss-cookbook/src/main/asciidoc/_restdocs/attestation-and-attestation-presentation/2/httpie-request.adoc[Request]
* *Curl*: https://github.com/esig/dss/blob/master/dss-cookbook/src/main/asciidoc/_restdocs/attestation-and-attestation-presentation/2/curl-request.adoc[Request]
...
* *JSON*: https://github.com/esig/dss/blob/master/dss-cookbook/src/main/asciidoc/_restdocs/attestation-and-attestation-presentation/3/request-body.adoc[Request] | https://github.com/esig/dss/blob/master/dss-cookbook/src/main/asciidoc/_restdocs/attestation-and-attestation-presentation/3/response-body.adoc[Response]
* *HTTP*: https://github.com/esig/dss/blob/master/dss-cookbook/src/main/asciidoc/_restdocs/attestation-and-attestation-presentation/3/http-request.adoc[Request] | https://github.com/esig/dss/blob/master/dss-cookbook/src/main/asciidoc/_restdocs/attestation-and-attestation-presentation/3/http-response.adoc[Response]
* *HTTPie*: https://github.com/esig/dss/blob/master/dss-cookbook/src/main/asciidoc/_restdocs/attestation-and-attestation-presentation/3/httpie-request.adoc[Request]
* *Curl*: https://github.com/esig/dss/blob/master/dss-cookbook/src/main/asciidoc/_restdocs/attestation-and-attestation-presentation/3/curl-request.adoc[Request]
...
* *JSON*: https://github.com/esig/dss/blob/master/dss-cookbook/src/main/asciidoc/_restdocs/attestation-and-attestation-presentation/4/request-body.adoc[Request] | https://github.com/esig/dss/blob/master/dss-cookbook/src/main/asciidoc/_restdocs/attestation-and-attestation-presentation/4/response-body.adoc[Response]
* *HTTP*: https://github.com/esig/dss/blob/master/dss-cookbook/src/main/asciidoc/_restdocs/attestation-and-attestation-presentation/4/http-request.adoc[Request] | https://github.com/esig/dss/blob/master/dss-cookbook/src/main/asciidoc/_restdocs/attestation-and-attestation-presentation/4/http-response.adoc[Response]
* *HTTPie*: https://github.com/esig/dss/blob/master/dss-cookbook/src/main/asciidoc/_restdocs/attestation-and-attestation-presentation/4/httpie-request.adoc[Request]
* *Curl*: https://github.com/esig/dss/blob/master/dss-cookbook/src/main/asciidoc/_restdocs/attestation-and-attestation-presentation/4/curl-request.adoc[Request]
...
* *JSON*: https://github.com/esig/dss/blob/master/dss-cookbook/src/main/asciidoc/_restdocs/attestation-and-attestation-presentation/5/request-body.adoc[Request] | https://github.com/esig/dss/blob/master/dss-cookbook/src/main/asciidoc/_restdocs/attestation-and-attestation-presentation/5/response-body.adoc[Response]
* *HTTP*: https://github.com/esig/dss/blob/master/dss-cookbook/src/main/asciidoc/_restdocs/attestation-and-attestation-presentation/5/http-request.adoc[Request] | https://github.com/esig/dss/blob/master/dss-cookbook/src/main/asciidoc/_restdocs/attestation-and-attestation-presentation/5/http-response.adoc[Response]
* *HTTPie*: https://github.com/esig/dss/blob/master/dss-cookbook/src/main/asciidoc/_restdocs/attestation-and-attestation-presentation/5/httpie-request.adoc[Request]
* *Curl*: https://github.com/esig/dss/blob/master/dss-cookbook/src/main/asciidoc/_restdocs/attestation-and-attestation-presentation/5/curl-request.adoc[Request]
...
* *JSON*: https://github.com/esig/dss/blob/master/dss-cookbook/src/main/asciidoc/_restdocs/attestation-and-attestation-presentation/6/request-body.adoc[Request] | https://github.com/esig/dss/blob/master/dss-cookbook/src/main/asciidoc/_restdocs/attestation-and-attestation-presentation/6/response-body.adoc[Response]
* *HTTP*: https://github.com/esig/dss/blob/master/dss-cookbook/src/main/asciidoc/_restdocs/attestation-and-attestation-presentation/6/http-request.adoc[Request] | https://github.com/esig/dss/blob/master/dss-cookbook/src/main/asciidoc/_restdocs/attestation-and-attestation-presentation/6/http-response.adoc[Response]
* *HTTPie*: https://github.com/esig/dss/blob/master/dss-cookbook/src/main/asciidoc/_restdocs/attestation-and-attestation-presentation/6/httpie-request.adoc[Request]
* *Curl*: https://github.com/esig/dss/blob/master/dss-cookbook/src/main/asciidoc/_restdocs/attestation-and-attestation-presentation/6/curl-request.adoc[Request]
