...
Revocation data management is an essential part in the lifecycle of a digital certificate and thus of a digital signature too. Refer to the corresponding section about the <<RevocationDataManagementConcept, concepts of revocation data management>> for general information.
