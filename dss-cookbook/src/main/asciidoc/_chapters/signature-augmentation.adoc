...
As a direct signature creation to `BASELINE-T` level can be useful in order to provide the _best-signature-time_ (and a proof of existence of the signature, respectively) as close as possible to the claimed signing time.
