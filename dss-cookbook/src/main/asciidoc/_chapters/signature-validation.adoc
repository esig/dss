...
A sample of a DetailedReport is provided https://github.com/esig/dss/blob/master/dss-cookbook/src/main/asciidoc/_samples/detailed-report-example.xml[here], and an illustration on how to interpret "what when wrong" based on a detailed report is provided in <<DetaliedReportInterpretation>>
