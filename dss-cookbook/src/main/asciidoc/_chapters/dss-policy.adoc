...
.9+|EvidenceRecordConstraints     |EvidenceRecordValid             |LevelConstraint                   |Indication from ER or timestamp |SubIndication from ER or timestamp
                                  ...
                                  |HashTreeRenewal                 |LevelConstraint                   |INDETERMINATE +
                                                                                                       FAILED                |SIGNED_DATA_NOT_FOUND +
                                                                                                                              HASH_FAILURE
                                  |Cryptographic                   |CryptographicConstraint         2+|See CryptographicConstraint
.16+|EAAConstraints               |AttestationSignatureUnicity             |LevelConstraint                   |FAILED                |FORMAT_FAILURE
                                  ...
                                  |AttestationIdentifierPresent            |LevelConstraint                   |INDETERMINATE         |EAA_CONSTRAINTS_FAILURE
...
.17+|EAAConstraints               |EAAAdministrativeIssuanceDatePresent        |LevelConstraint       |INDETERMINATE         |EAA_CONSTRAINTS_FAILURE
                                  ...
                                  |AttestationSubject                      |LevelConstraint                   |INDETERMINATE         |EAA_CONSTRAINTS_FAILURE
                                  |AttestationSubjectPseudonym             |LevelConstraint                   |INDETERMINATE         |EAA_CONSTRAINTS_FAILURE
                                  ...
                                  |AttestationStatusPresent                |LevelConstraint                   |INDETERMINATE         |EAA_CONSTRAINTS_FAILURE
                                  |AttestationShortLived                   |LevelConstraint                   |INDETERMINATE         |EAA_CONSTRAINTS_FAILURE
                                  ...
                                  |AttestationSupportedClaims              |LevelConstraint                   |INDETERMINATE         |EAA_CONSTRAINTS_FAILURE
                                  |AttestationSupportedNamespaces          |LevelConstraint                   |INDETERMINATE         |EAA_CONSTRAINTS_FAILURE
                                  |Cryptographic                   |CryptographicConstraint         2+|See CryptographicConstraint
