 ...
 * Trust service equivalence mapping, in the context of Article 27(1) and Article 37(1) of the eIDAS Regulation (<<R12>>) - supporting that "if a Member State requires an advanced electronic signature/seal to use an online service offered by, or on behalf of, a public sector body, that Member State shall recognise advanced electronic signatures/seal, advanced electronic signatures/seal based on a qualified certificate for electronic signatures/seal, and qualified electronic signatures/seal in at least the formats or using methods defined in the implementing acts referred to in paragraph 5".

A Pilot for the International Compatibility of Trust Services based on the Mutual Recognition Agreement (as per Article 14 of eIDAS Regulation) can be found by the https://esignature.ec.europa.eu/efda/intl-pilot/#/screen/home/demo[link].
...
----
include::{sourcetestdir}/eu/europa/esig/dss/cookbook/example/validate/mra/UALOTLTest.java[tags=demo]
----
