...
Defined within `TLSource` predicated allow filtering of `TrustServiceProvider`s based on the JAXB object containing information extracted about the `TrustServiceProvider` from an XML Trusted List.
...
Defined within `TLSource` predicated allow filtering of specific `TSPService`s based on the JAXB object containing information extracted about the `TSPService` from an XML Trusted List.
