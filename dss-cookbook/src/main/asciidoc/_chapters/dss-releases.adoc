...
|v5.10.RC1         |February 2022           a|Main new features / improvements :
...
|v5.10.RC1         |February 2022           a|Bug fixes :
...
|v5.7.RC1     |June 2020                     a| * CertificatePool removal and performance amelioration;
                                               * QWAC validator;
                                               * New design of PDF reports;
                                               * Support of PSD2 attributes;
                                               * Support of EdDSA;
...
----
For a complete code please see the https://github.com/esig/dss/blob/master/dss-cookbook/src/test/java/eu/europa/esig/dss/cookbook/example/snippets/PAdESDisableVisualComparison.java[example].
