...
* *CB-AdES* - for CBOR Advanced Electronic Signatures (cf. <<R41>>);
...
|=======================
2+|XAdES				       2+|CAdES				             2+|PAdES                           |JAdES        |CB-AdES
|*EXTENDED* 	   |*BASELINE*	 |*EXTENDED*       |*BASELINE* 	   |*EXTENDED*	    |*BASELINE*     |*BASELINE*   |*BASELINE*
|XAdES-E-BES 	.2+|XAdES-B-B	 |CAdES-E-BES 	.2+|CAdES-B-B 	   |PAdES-E-BES  .2+|PAdES-B-B   .2+|JAdES-B-  .2+|CB-AdES-B-B
|XAdES-E-EPES					 |CAdES-E-EPES	 			       |PAdES-E-EPES

|XAdES-E-T 		.3+|XAdES-B-T    |CAdES-E-T 	.3+|CAdES-B-T   .3+| 	         .3+|PAdES-B-T   .3+|JAdES-B-T .3+|CB-AdES-B-T
|XAdES-E-C 		                 |CAdES-E-C
|XAdES-E-X 		                 |CAdES-E-X

|XAdES-E-X-L 	   |XAdES-B-LT   |CAdES-E-X-L      |CAdES-B-LT 	   |        	    |PAdES-B-LT     |JAdES-B-LT   |CB-AdES-B-LT
|XAdES-E-A 		   |XAdES-B-LTA	 |CAdES-E-A 	   |CAdES-B-LTA    |PAdES-E-LTV 	|PAdES-B-LTA    |JAdES-B-LTA  |CB-AdES-B-LTA
...
* AdES-BASELINE-*P*: Profile implementing the signature class _Basic Signature_ +
...
.6+|JAdES    .3+|Enveloping  |Compact Serialization            |icon:check-circle[role="lime"] |icon:check-circle[role="lime"] |icon:check-circle[role="lime"] |icon:check-circle[role="lime"] |icon:times-circle[role="red"]  |icon:times-circle[role="red"]  |icon:times-circle[role="red"]  |icon:times-circle[role="red"]  |icon:times-circle[role="red"]  |icon:times-circle[role="red"]
             ...
             .3+|Detached    |Compact Serialization            |icon:check-circle[role="lime"] |icon:check-circle[role="lime"] |icon:check-circle[role="lime"] |icon:check-circle[role="lime"] |icon:check-circle[role="lime"] |SigD only                      |icon:times-circle[role="red"]  |icon:times-circle[role="red"]  |icon:times-circle[role="red"]  |icon:times-circle[role="red"]
...
.4+|CB-AdES  .2+|Enveloping  |COSE_Sign1                       |icon:check-circle[role="lime"] |icon:check-circle[role="lime"] |icon:check-circle[role="lime"] |icon:check-circle[role="lime"] |icon:times-circle[role="red"]  |icon:times-circle[role="red"]  |icon:times-circle[role="red"]  |icon:check-circle[role="lime"] |icon:check-circle[role="lime"]  |icon:times-circle[role="red"]
                             |COSE_Sign                        |icon:check-circle[role="lime"] |icon:check-circle[role="lime"] |icon:check-circle[role="lime"] |icon:check-circle[role="lime"] |icon:times-circle[role="red"]  |icon:times-circle[role="red"]  |icon:check-circle[role="lime"] |icon:check-circle[role="lime"] |icon:check-circle[role="lime"] |icon:times-circle[role="red"]
             .2+|Detached    |COSE_Sign1                       |icon:check-circle[role="lime"] |icon:check-circle[role="lime"] |icon:check-circle[role="lime"] |icon:check-circle[role="lime"] |icon:check-circle[role="lime"] |SigD only                      |icon:times-circle[role="red"]  |icon:check-circle[role="lime"] |icon:check-circle[role="lime"] |icon:times-circle[role="red"]
                             |COSE_Sign                        |icon:check-circle[role="lime"] |icon:check-circle[role="lime"] |icon:check-circle[role="lime"] |icon:check-circle[role="lime"] |icon:check-circle[role="lime"] |SigD only                      |icon:check-circle[role="lime"] |icon:check-circle[role="lime"] |icon:check-circle[role="lime"] |icon:times-circle[role="red"]
...
| CB-AdES | | | icon:check-circle[role="lime"] | icon:check-circle[role="lime"] | icon:check-circle[role="lime"] | | | | | | | |
...
| CB-AdES | | | | | icon:check-circle[role="lime"] | | | | | | | |
...
* `XAdESDOMDocument` : internal implementation, used for caching XAdES related objects for performance improvement.
...
.5+|B-Level      .5+|Signed attributes                         |_class JAdESSignatureParameters_ +
                                                                ...
                                                                *#setSignatureType*                                     |/                                    |/                                        |/                                                          |typ
                                                               |_class JAdESSignatureParameters_ +
                                                                *#setIncludeKeyIdentifier*       +
                                                                *#setKeyIdentifier*                                     |/                                    |/                                        |/                                                          |kid
                                                               |_class JAdESSignatureParameters_ +
                                                                *#setX509Url*                                           |/                                    |/                                        |/                                                          |x5u
                                                               |_class JAdESSignatureParameters_ +
                                                                *#setSigningCertificateDigestMethod* +
                                                                *(DigestAlgorithm.SHA256)*                              |/                                    |/                                        |/                                                          |x5t#S256
.4+|B-Level      .4+|Signed attributes                         |_class JAdESSignatureParameters_ +
                                                                ...
                                                                *#setMimeType*  _or_ +
                                                                _class JAdESSignatureParameters_ +
                                                                *#setContentType*                                       |DataObjectFormat/MimeType            |mime-type                                |/                                                          |cty
                                                               |_class JAdESSignatureParameters_ +
...
WARNING: The parameter modifies default behavior the xades:DataObjectFormat elements are created. It is up to the implementer to ensure the validity of the defined configuration. The parameter is recommended to be used only by experienced users.
