...
----
include::{sourcetestdir}/eu/europa/esig/dss/cookbook/example/snippets/AppleSignatureToken.java[tags=demo]
----
...
.InMemoryDocument
----
include::{sourcetestdir}/eu/europa/esig/dss/cookbook/example/sources/DSSDocumentTest.java.java[tags=inMemoryDocument]
----

[source,java,indent=0]
.FileDocument
----
include::{sourcetestdir}/eu/europa/esig/dss/cookbook/example/sources/DSSDocumentTest.java.java[tags=fileDocument]
----

[source,java,indent=0]
.DigestDocument
----
include::{sourcetestdir}/eu/europa/esig/dss/cookbook/example/sources/DSSDocumentTest.java.java[tags=digestDocument]
----

[source,java,indent=0]
.HTTPHeader
----
include::{sourcetestdir}/eu/europa/esig/dss/cookbook/example/sources/DSSDocumentTest.java.java[tags=httpHeader]
----
...
----
include::{sourcetestdir}/eu/europa/esig/dss/cookbook/example/snippets/Snippets.java.java[tags=threeStepsSign]
----
