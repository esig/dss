...
.InMemoryDocument
----
include::{sourcetestdir}/eu/europa/esig/dss/cookbook/example/sources/InMemoryDocumentTest.java[tags=demo]
----

[source,java,indent=0]
.FileDocument
----
include::{sourcetestdir}/eu/europa/esig/dss/cookbook/example/sources/FileDocumentTest.java[tags=demo]
----
...
!!! TODO: create the example MultipleSignXadesBTest.java !!!
[source,java,indent=0]
