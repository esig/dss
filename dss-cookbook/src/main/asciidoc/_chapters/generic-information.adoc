...
|[[R23]]    R23 |Internet RFC 5280: Internet X.509 Public Key Infrastructure Certificate and Certificate Revocation List (CRL) Profile   |https://www.ietf.org/rfc/rfc5280.txt[RFC 5280]                                                                        |
|[[R24]]    R24 |Internet RFC 6960: X.509 Internet Public Key Infrastructure Online Certificate Status Protocol - OCSP      |https://www.ietf.org/rfc/rfc6960.txt[RFC 6960]                                                                                     |
|[[R25]]    R25 |Common PKI Specifications for Interoperable Applications from T7 & TeleTrusT   |https://www.bundesnetzagentur.de/EVD/DE/SharedDocuments/Downloads/Anbieter_Infothek/Common_PKI_v2.0_02.pdf?__blob=publicationFile&v=1[Common PKI v2.0]         |2.0 (January 2009)
|[[R26]]    R26 |Electronic Signatures and Infrastructures (ESI); Certificate Profiles; Part 5: QCStatements                |https://www.etsi.org/deliver/etsi_en/319400_319499/31941205/02.04.01_60/en_31941205v020401p.pdf[ETSI EN 319 412-5]                 |2.4.1 (2023-09)
|[[R27]]    R27 |Document management - Portable document format - Part 2: PDF 2.0               |https://developer.adobe.com/document-services/docs/assets/5b15559b96303194340b99820d3a70fa/PDF_ISO_32000-2.pdf[ISO 32000-2]                       	            |2.0 (2017)
