...
$ curl 'http://localhost:8080/services/rest/signature/one-document/signDocument' -i -X POST \
  ...
  "signatureValue" : {
    ...
    "value" : ""
  },
  "toSignDocument" : {
    "bytes" : "SGVsbG8=",
