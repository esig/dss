...
$ curl 'http://localhost:8080/services/rest/signature/multiple-documents/signDocument' -i -X POST \
  ...
  "signatureValue" : {
    ...
    "value" : ""
  },
  "toSignDocuments" : [ {
    "bytes" : "SGVsbG8=",
