...
.Request
include::_restdocs/timestamp-one-document/http-request.adoc[]

.Response
include::_restdocs/timestamp-one-document/http-response.adoc[]
...
.Request
include::_restdocs/get-timestamp-response/http-request.adoc[]

.Response
include::_restdocs/get-timestamp-response/http-response.adoc[]