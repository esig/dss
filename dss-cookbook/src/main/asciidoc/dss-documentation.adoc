...
:keywords: electronic signature, XAdES, CAdES, PAdES, JAdES, CB-AdES, ASiC, EAA, SD-JWT, mdoc, open source, validation
...
include::_chapters/attestation.adoc[]

include::_chapters/trusted-lists.adoc[]

include::_chapters/lists-of-trusted-entities.adoc[]

include::_chapters/eIDAS.adoc[]

include::_chapters/webservices.adoc[]

include::_chapters/pki-factory.adoc[]
