...
[[NonEUTrustedListLoadingSnippet.java]]
[source,java,indent=0]
.NonEUTrustedListLoadingSnippet.java
----
include::{sourcetestdir}/eu/europa/esig/dss/cookbook/example/snippets/NonEUTrustedListLoadingSnippet.java[tags=demo]
----
