...
The documentation will covers the REST calls. All the REST services present in DSS are compliant with http://cxf.apache.org/docs/openapifeature.html[OpenAPI Specification].
