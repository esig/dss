...
WARNING: Before processing the build steps, please, ensure you have succesfully installed Maven and JVM with a required version.
 ...
 * Java 8 and higher;
 * Maven 3.3 and higher (if build required);
