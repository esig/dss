...
----
include::{sourcetestdir}/eu/europa/esig/dss/cookbook/example/sign/SignXmlXadesBWithTransformsTest.java[tags=prefixes]
----
...
The documentation will covers the REST calls. All the REST services present in DSS are complaint with http://cxf.apache.org/docs/openapifeature.html[OpenAPI Specification].
