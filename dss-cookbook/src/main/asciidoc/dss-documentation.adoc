...
An Example of usage `Repository Revocation Source` can be found below (CRL implementation):
...
In the next source code you can find an example of Spring Hibernate implementation of the `Repository Revocation Source`:

[source,java,indent=0]
.HibernateRevocation implementation example
----
include::samples/snippets/HibernateRevocationSourceJava[tags=demo]
----
