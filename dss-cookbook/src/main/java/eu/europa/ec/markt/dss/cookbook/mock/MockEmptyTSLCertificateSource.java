...
public class MockEmptyTSLCertificateSource extends CommonTrustedCertificateSource {
	...
	/**
	 * This method allows to define (to add) any certificate as trusted. A mock service information is associated to this certificate.
	 *
	...
	/**
	 * This method returns the mock service information. It is used when the framework user wants to declare a certificate as
	 * trusted one.
	 *
	 * @return
	 */
