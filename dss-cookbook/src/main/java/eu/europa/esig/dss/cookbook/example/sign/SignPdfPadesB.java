 ...
 */
public class SignPdfPadesB {

	public static void main(final String[] args) throws IOException {
		// GET document to be signed -
		// Return DSSDocument toSignDocument
		DSSDocument pdfDocument = new FileDocument("src/main/resources/hello-world.pdf");
		...
		try (Pkcs12SignatureToken signingToken = new Pkcs12SignatureToken("src/main/resources/user_a_rsa.p12",
			...
			// We save the signed document on the filesystem
			signedDocument.save("target/signedPdfPadesB.pdf");
		}
	}
}
