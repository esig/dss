...
public interface Encoder {
	 ...
	 * @throws DSSException an encoder exception is thrown if the encoder experiences a failure condition during the encoding process.
	 */
	Object encode(Object source) throws DSSException;
}  
