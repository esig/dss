...
public abstract class BaseNCodec implements BinaryEncoder, BinaryDecoder {
    ...
    public Object encode(Object pObject) throws DSSException {
        if (!(pObject instanceof byte[])) {
            throw new DSSException("Parameter supplied to Base-N encode is not a byte[]");
        }
    ...
    public Object decode(Object pObject) throws DSSException {
        if (pObject instanceof byte[]) {
            ...
            throw new DSSException("Parameter supplied to Base-N decode is not a byte[] or a String");
        }
    }
    ...
    public byte[] decode(String pArray) {
        return decode(DSSUtils.getUtf8Bytes(pArray));
    }
