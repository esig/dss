...
import eu.europa.ec.markt.dss.applet.component.model.XsdNodeType;
import eu.europa.ec.markt.dss.applet.component.model.validation.ValidationPolicyTreeModel;
import eu.europa.ec.markt.dss.applet.component.model.validation.XMLTreeCellRenderer;
                ...
                public void actionPerformed(ActionEvent actionEvent) {
                    ...
                    if (xsdChild.getType() == XsdNodeType.TEXT) {
                        ...
                        for (final XsdNode allowed : childrenMap.keySet()) {
                            ...
                            if (toAddSeen) {
                                final NodeList elementsByTagNameNS = clickedElement.getElementsByTagNameNS("http://dss.markt.ec.europa.eu/validation/diagnostic", allowed.getLastNameOfPath());
