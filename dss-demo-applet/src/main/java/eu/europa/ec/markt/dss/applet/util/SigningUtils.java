...
public final class SigningUtils {
	 ...
	 * @throws DSSException
	 */
	public static DSSDocument extendDocument(final String serviceURL, final File signedFile, final File detachedFile, final WsParameters wsParameters) throws DSSException {
		try {
