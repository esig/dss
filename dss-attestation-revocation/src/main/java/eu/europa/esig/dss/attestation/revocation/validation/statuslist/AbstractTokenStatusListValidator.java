...
public abstract class AbstractTokenStatusListValidator implements TokenStatusListValidator {
    ...
    public AttestationRevocationToken getRevocationToken(int index) {
        ...
        if (signature != null) {
            ...
            return TokenStatusList.initBuilder()
                    ...
                    .setStatus(getAttestationStatus(statusListPayload, index))
                    .build();
        }
        return null;
    }
    ...
    /**
     * Gets the attestation Status for the given {@code attestation} based on the information retrieved from {@code statusListPayload}
     *
     ...
     */
    protected AttestationStatus getAttestationStatus(StatusListPayload statusListPayload, int index) {
