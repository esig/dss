...
/**
 * Loads a relevant implementation for an attestation's Token Status List (TSL) processing
 *
 */
public interface TokenStatusListValidatorFactory {

    /**
     * This method tests if the current implementation of {@link TokenStatusListValidator}
     * supports the given document
     *
     * @param tokenStatusList
     *                 the document to be tested
     * @return true, if the {@link TokenStatusListValidator} supports the given document
     */
    boolean isSupported(byte[] tokenStatusList);
     ...
     */
    TokenStatusListValidator create(byte[] tokenStatusList);
