 ...
 */
package eu.europa.esig.dss.attestation.revocation.model.statuslist;
...
/**
 * Represents a validated Token Status List response against a given attestation
 *
 */
public class TokenStatusList extends AttestationRevocationToken {
    ...
    /**
     * Builder to create the attestation Status Token
     *
     */
