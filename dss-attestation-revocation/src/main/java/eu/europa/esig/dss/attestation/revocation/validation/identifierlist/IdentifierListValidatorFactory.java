...
/**
 * Loads a relevant implementation for an attestation's Identifier List processing
 *
 */
public interface IdentifierListValidatorFactory {
     ...
     */
    boolean isSupported(byte[] identifierList);
     ...
     */
    IdentifierListValidator create(byte[] identifierList);
