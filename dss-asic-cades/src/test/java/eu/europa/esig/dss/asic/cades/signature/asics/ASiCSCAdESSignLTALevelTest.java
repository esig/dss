...
class ASiCSCAdESSignLTALevelTest extends PKIFactoryAccess {
	...
	void test() throws IOException {
		...
		DefaultASiCContainerExtractor extractor = new ASiCWithCAdESContainerExtractor(doubleSignedDocument);
