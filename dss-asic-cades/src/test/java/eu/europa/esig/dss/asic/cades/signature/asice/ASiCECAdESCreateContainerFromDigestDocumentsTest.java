...
class ASiCECAdESCreateContainerFromDigestDocumentsTest extends AbstractASiCECAdESTestSignature {
    ...
    protected DSSDocument sign() {
        ...
        ASiCContent digestASiCContent = new ASiCWithCAdESASiCContentBuilder().build(
                Collections.singletonList(digestDocument), signatureParameters.aSiC().getContainerType());
        DSSDocument manifestDocument = new ASiCWithCAdESSignatureManifestBuilder(digestASiCContent,
                signatureParameters.getDigestAlgorithm(), signatureFilename, asicWithCAdESFilenameFactory).build();
