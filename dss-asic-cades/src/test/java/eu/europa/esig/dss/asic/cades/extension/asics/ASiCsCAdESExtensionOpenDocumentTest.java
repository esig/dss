...
class ASiCsCAdESExtensionOpenDocumentTest extends PKIFactoryAccess {
	...
	void test() {
		...
		Exception exception = assertThrows(IllegalInputException.class, () -> service.extendDocument(documentToExtend, signatureParameters));
