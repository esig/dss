...
public class ASiCEWithCAdESLevelLTWithEvidenceRecordChainRenewalInvalidRefValidationTest extends AbstractASiCEWithCAdESWithEvidenceRecordTestValidation {

    @Override
    protected DSSDocument getSignedDocument() {
        return new FileDocument("src/test/resources/validation/evidencerecord/cades-lt-with-er-chain-renewed-invalid-ref.sce");
    }
