...
public class ASiCEWithCAdESLevelBContainerMergerCustomMimetypeTest extends AbstractWithCAdESTestMerge {
    ...
    public void init() {
        ...
        secondSignatureParameters.aSiC().setZipComment(true);
