...
public class ASiCEWithCAdESLevelBContainerMergerDifferentMimetypeTest extends AbstractWithCAdESTestMerge {
    ...
    public void init() {
        ...
        firstSignatureParameters.aSiC().setMimeType(MimeType.ASICE.getMimeTypeString());
