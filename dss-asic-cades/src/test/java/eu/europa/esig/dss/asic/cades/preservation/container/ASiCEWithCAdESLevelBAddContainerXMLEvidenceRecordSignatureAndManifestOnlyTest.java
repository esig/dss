...
class ASiCEWithCAdESLevelBAddContainerXMLEvidenceRecordSignatureAndManifestOnlyTest extends AbstractASiCWithCAdESTestAddContainerEvidenceRecord {
    ...
    protected DSSDocument getEvidenceRecordDocument() {
        return new FileDocument("src/test/resources/validation/evidencerecord/incorporation/evidence-record-asic_cades-signature-and-manifest.xml");
    }
    ...
    public void addERAndValidate() {
        ...
        assertEquals("The original document with name 'document.odt' is not covered by " +
