...
public final class DefaultKeyManager implements X509KeyManager {
     ...
     * @throws IOException I/O Error
     */
    private void initKeyManager(final KeyStore keystore, final String ksPasswd) throws KeyStoreException, NoSuchAlgorithmException, CertificateException, IOException, UnrecoverableKeyException { // NOPMD
