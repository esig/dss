...
import eu.europa.esig.dss.attestation.revocation.jwt.model.statuslist.JWTStatusListPayload;
import eu.europa.esig.dss.attestation.revocation.validation.statuslist.AbstractTokenStatusListValidator;
 ...
 *
 */
public class JWTTokenStatusListValidator extends AbstractTokenStatusListValidator {

    private static final Logger LOG = LoggerFactory.getLogger(JWTTokenStatusListValidator.class);

    /**
     * Empty constructor
     */
    public JWTTokenStatusListValidator() {
        super();
    }
     ...
     */
    public JWTTokenStatusListValidator(final byte[] statusListDocument) {
