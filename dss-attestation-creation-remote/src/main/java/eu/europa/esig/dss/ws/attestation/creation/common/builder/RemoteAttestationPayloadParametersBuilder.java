...
import eu.europa.esig.dss.attestation.sd.jwt.creation.ETSITokenStatusList;
import eu.europa.esig.dss.attestation.sd.jwt.creation.SDJWTClaimParameters;
import eu.europa.esig.dss.attestation.sd.jwt.creation.SDJWTPayloadParameters;
import eu.europa.esig.dss.attestation.mdoc.creation.MdocClaimParameters;
import eu.europa.esig.dss.attestation.mdoc.creation.MdocPayloadParameters;
import eu.europa.esig.dss.attestation.mdoc.creation.MdocIdentifierList;
...
import eu.europa.esig.dss.ws.attestation.creation.common.converter.SDJWTClaimFromDTOConverter;
import eu.europa.esig.dss.ws.attestation.creation.dto.parameters.AgeOverNNDTO;
import eu.europa.esig.dss.ws.attestation.creation.dto.parameters.BiometricTemplateNNDTO;
import eu.europa.esig.dss.ws.attestation.creation.dto.parameters.DrivingPrivilegeCodeDTO;
